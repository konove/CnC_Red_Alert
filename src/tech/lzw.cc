 ...
 *exclusive OR combination of the prefix and character.                        *
 *    This code also has to check for collisions, and handles them by * jumping
 *around in the table. *
 *                                                                                             *
 ...
 *                                                                                             *
 * OUTPUT:  Returns with the index for the matching dictionary entry. If no
 *matching index     * could be found, then it returns with the index to an
 *unused dictionary entry. If   * there are also no unused entries in the
 *dictionary, then -1 is returned.           *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 08/28/1996 JLB : Created. *
 *=============================================================================================*/
