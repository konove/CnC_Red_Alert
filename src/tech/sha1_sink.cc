...
/***********************************************************************************************
 * Sha1Sink::Put -- Pass data through the pipe, but use it to build a SHA
 * digest.
 **
 *                                                                                             *
 *    This pipe segment will not modify the data, but it will examine the data
 *and use it when * building a SHA digest. *
 *                                                                                             *
 * INPUT:   source   -- Pointer to the data to flow through the pipe. *
 *                                                                                             *
 *          length   -- The number of bytes to submit. *
 *                                                                                             *
 * OUTPUT:  Returns with the actual number of bytes output at the distant final
 ...
 *=============================================================================================*/
bool Sha1Sink::Write(std::span<const std::byte> bytes) {
