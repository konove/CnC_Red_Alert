...
#ifndef CNC_RED_ALERT_TECH_RANDOM_SOURCE_H_
#define CNC_RED_ALERT_TECH_RANDOM_SOURCE_H_
...
*/
class RandomSource : public ByteSource {
 public:
...
#endif  // CNC_RED_ALERT_TECH_RANDOM_SOURCE_H_
