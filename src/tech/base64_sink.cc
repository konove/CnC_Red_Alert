 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * Base64Sink::Put -- Processes a block of data through the pipe. *
 *   Base64Sink::Flush -- Flushes the final pending data through the pipe. *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
/***********************************************************************************************
 * Base64Sink::Put -- Processes a block of data through the pipe. *
 *                                                                                             *
 ...
 *=============================================================================================*/
bool Base64Sink::Write(std::span<const std::byte> bytes) {
  ...
  if (Counter > 0) {
    ...
    if (Counter == fromsize) {
      ...
      ChainedSink::Write(ByteView(to, outcount));
      Counter = 0;
    }
  }
