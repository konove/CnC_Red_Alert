 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * Sha1Source::Get -- Fetch data from the straw and process the SHA
...
/***********************************************************************************************
 * Sha1Source::Get -- Fetch data from the straw and process the SHA with the
 * data.
 **
 *                                                                                             *
 ...
 *=============================================================================================*/
base::ssize Sha1Source::Read(std::span<std::byte> buffer) {
  if (buffer.empty()) {
    return 0;
  }

  const base::ssize counter = ChainedSource::Read(buffer);
