 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * LzoSource::Get -- Fetch data through the LZO processor. *
 *   LzoSource::LzoSource -- Constructor for LZO straw object. *
 *   LzoSource::~LzoSource -- Destructor for the LZO straw. *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *=============================================================================================*/
LzoSource::LzoSource(CodecMode control, ByteSource& source, int blocksize)
...
/***********************************************************************************************
 * LzoSource::Get -- Fetch data through the LZO processor. *
 *                                                                                             *
 ...
 * HISTORY: * 07/04/1996 JLB : Created. *
 *=============================================================================================*/
base::ssize LzoSource::Read(std::span<std::byte> buffer) {
  ...
  while (slen > 0) {
    ...
    */
    ...
    if (Control == CodecMode::kDecompress) {
      ...
      incount = static_cast<int>(ChainedSource::Read(
