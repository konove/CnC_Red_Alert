...
class HSVClass {
 ...
 public:
  ...
  [[nodiscard]] int Hue_Component() const { return Hue; }
  [[nodiscard]] int Saturation_Component() const { return Saturation; }
  [[nodiscard]] int Value_Component() const { return Value; }
