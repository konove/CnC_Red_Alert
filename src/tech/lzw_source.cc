 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * LzwSource::Get -- Fetch data through the LZW processor. *
 *   LzwSource::LzwSource -- Constructor for LZW straw object. *
 *   LzwSource::~LzwSource -- Destructor for the LZW straw. *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *=============================================================================================*/
LzwSource::LzwSource(CodecMode control, ByteSource& source, int blocksize)
...
/***********************************************************************************************
 * LzwSource::Get -- Fetch data through the LZW processor. *
 *                                                                                             *
 ...
 * HISTORY: * 07/04/1996 JLB : Created. *
 *=============================================================================================*/
base::ssize LzwSource::Read(std::span<std::byte> buffer) {
    ...
    */
    ...
    if (Control == CodecMode::kDecompress) {
      ...
      BlockHeader.UncompCount =
          static_cast<uint16_t>(static_cast<int>(ChainedSource::Read(
