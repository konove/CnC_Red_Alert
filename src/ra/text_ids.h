...
*/
#ifndef CNC_RED_ALERT_RA_TEXT_IDS_H_
#define CNC_RED_ALERT_RA_TEXT_IDS_H_

// File: Indices into the language string table (the TXT_* ids).
...
#endif  // CNC_RED_ALERT_RA_TEXT_IDS_H_
