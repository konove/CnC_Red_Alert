...
// function distinguishing error (actually not an error when conversion
// operators are used).
// lint -e1053

/*
**	The current version of Lint doesn't know how to deal with conversion
*operators. It *	erroneously generates this error message as a result.
*Unfortunately, we have to throw *	out the baby with the bathwater on this
*one.
*/
// lint -e58 -e56
...
/*
**	Disable warning about non virtual base class destructor for these
*objects.
*/
// lint
...
/*
**	Calling "new" when not part of an assignment operation can be valid.
*This *	is true if the "new" operator has been overloaded and the class keeps
**	track of itself.
*/
// lint -e522
