 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * InfantryTypeClass::As_Reference -- Fetches a reference to the
 *infantry type specified.    * InfantryTypeClass::Create_And_Place -- Creates
 *and places infantry object onto the map.   * InfantryTypeClass::Create_One_Of
 *-- Creates an infantry object.                           *
 *   InfantryTypeClass::Display -- Displays a generic infantry object. *
 *   InfantryTypeClass::From_Name -- Converts an ASCII name into an infantry
 *type number.      * InfantryTypeClass::Full_Name -- Fetches the full name text
 *number.                        * InfantryTypeClass::Get_Cameo_Data -- Fetches
 *the small cameo shape for sidebar strip.     *
 *   InfantryTypeClass::InfantryTypeClass -- Constructor for infantry type class
 *objects.      * InfantryTypeClass::Init_Heap -- Initialize the infantry type
 *class heap.                  * InfantryTypeClass::Occupy_List -- Returns with
 *default infantry occupation list.          * InfantryTypeClass::One_Time --
 *Performs any one time processing for infantry system.      *
 *   InfantryTypeClass::Prep_For_Add -- Prepares the scenario editor for adding
 *of infantry obj* InfantryTypeClass::Read_INI -- Fetches infantry override
 *values from the INI database.    * InfantryTypeClass::operator delete -- Frees
 *an infantry type class object.                * InfantryTypeClass::operator
 *new -- Allocate an infanty type class object.                 *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *objects.        *
 *                                                                                             *
 *    This routine will construct the infantry type objects. It is use to create
 *the static    * infantry types that are used to give each of the infantry
 ...
 *                                                                                             *
 *    This will allocate an infantry type class object from the special memory
 *pool of that    * purpose. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the infantry type class object allocated.
 *If there was   * insufficient memory to fulfill the request, then NULL is
 *returned.                 *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This will return a previously allocated infantry type class object back to
 *the memory    * pool from whence it came. *
 *                                                                                             *
 ...
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   Call this routine once and before the rules.ini file is
 *processed.              *
 *                                                                                             *
 * HISTORY: * 07/11/1996 JLB : Created. *
 *=============================================================================================*/
 ...
 *                                                                                             *
 *    This creates an infantry object, but does not attempt to place it on the
 *map. It is      * typically used by the scenario editor when an object is
 *needed, but the location has     * not yet been specified for where it should
 *appear on the map.                            *
 *                                                                                             *
 * INPUT:   house -- The owner of the infantry object. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the created infantry object. If an object
...
/***********************************************************************************************
 * InfantryTypeClass::Create_And_Place -- Creates and places infantry object
 *onto the map.     *
 *                                                                                             *
 *    This routine is used by the scenario editor to create and place an
 *infantry object onto  * the map at the location specified. *
 *                                                                                             *
 * INPUT:   cell     -- The cell location to place the infantry object at. *
 *                                                                                             *
 *          house    -- The owner of the infantry object. *
 *                                                                                             *
 * OUTPUT:  bool; Was the infantry object successfully created and placed at the
 *location      * specified? *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
...
/***********************************************************************************************
 * InfantryTypeClass::Occupy_List -- Returns with default infantry occupation
 *list.            *
 *                                                                                             *
 *    This routine will return with a cell offset occupation list for a generic
 *infantry       * object. This is typically just a single cell since infantry
 *are never bigger than one    * cell and this routine presumes the infantry is
 ...
 *                                                                                             *
 * OUTPUT:  Returns with a cell offset list for the infantry object as if it
 *were located      * in the center of a cell. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 09/24/1994 JLB : Created. *
 ...
 * InfantryTypeClass::Display -- Displays a generic infantry object. *
 *                                                                                             *
 *    This routine is used by the scenario editor to display a generic
 *representation of the   * infantry object for the scenario editor. It simply
 *draws a single (nice profile) view    * of the infantry type. *
 *                                                                                             *
 * INPUT:   x,y      -- The display coordinates to render the infantry object
 *at.              *
 *                                                                                             *
 *          window   -- The window that the display coordinates are relative to.
 **
 *                                                                                             *
 *          house    -- The house colors to use when rendering this infantry
 *object.           *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
...
/***********************************************************************************************
 * InfantryTypeClass::Prep_For_Add -- Prepares the scenario editor for adding of
 *infantry object.*
 *                                                                                             *
 *    This routine will prepare the scenario editor so that the infantry objects
 *appear on     * the object list. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  none *
 ...
 *number.        *
 *                                                                                             *
 *    This routine is used to convert the infantry ASCII name as specified into
 *an infantry    * type number. This is called from the INI reader routine in
 *the process if creating the   * infantry objects needed for the scenario. *
 *                                                                                             *
 * INPUT:   name  -- The ASCII name to convert into an infantry type number. *
 *                                                                                             *
 * OUTPUT:  Returns with the infantry type number that corresponds to the
 *infantry ASCII name  * specified. If no match could be found, then
 *INFANTRY_NONE is returned.             *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 09/24/1994 JLB : Created. *
...
/***********************************************************************************************
 * InfantryTypeClass::One_Time -- Performs any one time processing for infantry
 *system.        *
 *                                                                                             *
 *    This routine will perform one time processing for the infantry type
 *system. This is      * generally restricted to loading of the infantry shape
 *data.                              *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine will fetch the full name text number for this infantry type.
 *It examines    * the special custom name flag to determine whether the custom
 *name or the generic name    * is to be used. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  Returns with text number for the name to give this infantry type
 *object.           *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
...
/***********************************************************************************************
 * InfantryTypeClass::As_Reference -- Fetches a reference to the infantry type
 *specified.      *
 *                                                                                             *
 *    Use this routine to convert an infantry type number into a reference to
 *the infantry     * type class object it represents. *
 *                                                                                             *
 * INPUT:   type  -- The infantry type number to convert into a infantry type
 *class object.    *
 *                                                                                             *
 * OUTPUT:  Returns with a reference to the infantry type class object
 *specified.              *
 *                                                                                             *
 * WARNINGS:   Be sure that the type parameter is legal, otherwise the results
 *are undefined.  *
 *                                                                                             *
 * HISTORY: * 07/11/1996 JLB : Created. *
 *=============================================================================================*/
...
/***********************************************************************************************
 * InfantryTypeClass::Read_INI -- Fetches infantry override values from the INI
 *database.      *
 *                                                                                             *
 *    This routine will retrieve the override values for this infantry type
 *class object from  * the INI database specified. *
 *                                                                                             *
 * INPUT:   ini   -- Reference to the INI database to retrieve the data from. *
 *                                                                                             *
 * OUTPUT:  bool; Was the infantry section for this type found and data
 *retrieved from it?     *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
