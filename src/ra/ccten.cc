 ...
 *                                                                         *
 * INPUT:                                                                  *
 *		id			connection ID to destroy (must be a
 *HousesType)					* error		0 = user signed
 *off; 1 = connection error; otherwise, 		* no error is shown.
 **
 *                                                                         *
 * OUTPUT:                                                                 *
 *		none.
...
void Debug_Mono() {
  ...
  for (i = 0; i < Ten->Num_Connections(); i++) {
    ...
    Mono_Printf("Connection %d: Name:%s, ID:%d, Address:%d\n", i,
                Ten->Connection_Name(id), Ten->Connection_ID(i),
