 ...
 *                                                                         *
 * INPUT:                                                                  *
 *		text		text to add to list * color		color
 *for item                                          		*
 *                                                                         *
 * OUTPUT:                                                                 *
 ...
 *                                                                         *
 * INPUT:                                                                  *
 *		style		style to draw * color		color to draw
 *the special style in; -1 = use item's color	*
 *                                                                         *
 * OUTPUT:                                                                 *
 *		none. *
 *                                                                         *
 ...
 *   04/19/1995 BRR : Created.                                             *
 *=========================================================================*/
void ColorListClass::Set_Selected_Style(SelectStyleType style,
