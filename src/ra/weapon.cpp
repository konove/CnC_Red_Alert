 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * Armor_From_Name -- Convert ASCII name into armor type number. *
 *   WeaponTypeClass::As_Pointer -- Give a weapon type ID, fetch pointer to
 *weapon type object.* WeaponTypeClass::Read_INI -- Fetch the weapon data from
 *the INI database.                 * WeaponTypeClass::WeaponTypeClass --
 *Default constructor for weapon type objects.          *
 *   WeaponTypeClass::operator delete -- Returns weapon type object back to
 *special heap.      * WeaponTypeClass::operator new -- Allocates a weapon type
 *object form the special heap.    * WeaponTypeClass::~WeaponTypeClass --
 *Destructor for weapon type class objects.            * Weapon_From_Name --
 *Conver ASCII name to weapon type ID number.                           *
 *   WeaponTypeClass::Allowed_Threats -- Determine what threats this weapon can
 *address.       *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *objects.            *
 *                                                                                             *
 *    This default constructor will initialize all the values of the weapon to
 *the default     * state. Thus, if any of these settings are not specifically
 *overridden by the rules.ini   * file, they will remain this value in the game.
 **
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 ...
 *objects.              *
 *                                                                                             *
 *    This destructor really doesn't do anything but set the pointers to NULL.
 *This is a       * general purposes safety tactic but is otherwise useless. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  none *
...
/***********************************************************************************************
 * WeaponTypeClass::operator new -- Allocates a weapon type object form the
 *special heap.      *
 *                                                                                             *
 *    This will allocate a weapon type object from a special heap that has been
 *set up for     * that purpose. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the weapon type object allocated. If there
 *was           * insufficient memory available, NULL is returned. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 07/17/1996 JLB : Created. *
 ...
 *special heap.        *
 *                                                                                             *
 *    This routine will return the weapon type object back to the heap so that
 *the memory      * can be reused for subsiquent allocations of weapon type
 *objects.                         *
 *                                                                                             *
 * INPUT:   pointer  -- Pointer to the weapon type object to return to the
 *special heap.       *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
...
/***********************************************************************************************
 * WeaponTypeClass::As_Pointer -- Give a weapon type ID, fetch pointer to weapon
 *type object.  *
 *                                                                                             *
 *    This routine will conver the weapon type ID specified into a pointer to
 *the weapon type  * object it represents. *
 *                                                                                             *
 * INPUT:   weapon   -- The weapon type object ID to convert to a pointer. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the weapon type class object that is
 *represented by the  * weapon ID number specified. If no match could be found,
 ...
 *                                                                                             *
 *    This routine will fetch the weapon data for this weapon type object from
 *the INI         * database specified. *
 *                                                                                             *
 * INPUT:   ini   -- Reference to the INI database that the weapon data will be
 *fetched        * from. *
 *                                                                                             *
 * OUTPUT:  bool; Was this weapon type described in the database and the values
 *retrieved?     *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This will find the weapon whos name matches that specified and then it
 *will return the   * weapon ID number associated with it. *
 *                                                                                             *
 * INPUT:   name  -- Pointer to the ASCII name of the weapon type. *
 *                                                                                             *
 * OUTPUT:  Returns with the weapon type ID number that matches the name
 *specified. If no      * match could be found, then WEAPON_NONE is returned. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 07/17/1996 JLB : Created. *
 ...
 *                                                                                             *
 *    This will find the armor type that matches the ASCII name specified and
 *then will return * the armor ID number of it. *
 *                                                                                             *
 * INPUT:   name  -- Pointer to the ASCII name of the armor to find. *
 *                                                                                             *
 * OUTPUT:  Returns with the armor ID number of the armor that matches the name
 *specified. If  * no match could be found, then ARMOR_NONE is returned. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 07/17/1996 JLB : Created. *
 ...
 *address.         *
 *                                                                                             *
 *    This routine will examine the capabilities of this weapon and return with
 *the threat     * types that it can address. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
