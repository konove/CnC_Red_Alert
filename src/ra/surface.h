...
*memory space. Typically, *	this represents what could be called a graphic
*buffer or even a portion of a graphic buffer. *	It can also represent a
*piece of artwork (such as a shape image) to be used to construct a *	display
*image. This wide range of use is possible, because this class is a very minimal
**	representation of the graphic data. It holds only the information is
*absolutely needs and *	has the minimum member functions possible.
*/
class Surface {
 public:
  ...
  **	minimum of parameters can be specified. These routine ultimately map to
  *the *	basic copy routines.
  */
  ...
  *allocated memory *	managed by this class but more likely, it is memory that
  *is merely referred to by *	this class.
  */
  Buffer SurfaceData;
  ...
  */
  ...
  /*
  **	This is the modulus of the surface underlying memory 'display surface'
  *width *	divided by this surface's width. For a surface that is full
  *width, this value *	will be 0. This value will be non-zero if this surface
  *is referring to a *	sub-region within another surface.
  */
  int Pitch;
};
