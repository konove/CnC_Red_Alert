...
*compression, encryption, or *	data analysis classes. The Transmuter should be
*derived into a class that performs the necessary *	processing.
*/
class Transmuter {
 public:
  Transmuter() : Output(nullptr) {}
  virtual ~Transmuter() {}

  /*
  **	These are the interface function that are used to pass data to the
  *transmuter. The *	default implementation of these functions do nothing
  *other than pass the data onto *	the subsequent transmuter. For practical
