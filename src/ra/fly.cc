 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * FlyClass::Fly_Speed -- Sets the flying object to the speed
 *specified.                     * FlyClass::Physics -- Performs vector physics
 *(movement).                                  *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *                                                                                             *
 *    This routine performs movement (vector) physics. It takes the * specified
 *location and moves it according to the facing and speed * of the vector. It
 *returns the status of the move.                                        *
 *                                                                                             *
 * INPUT:   coord -- Reference to the coordinate that the vector will * be
 *applied to.                                                            *
 *                                                                                             *
 * OUTPUT:  Returns with the status of the vector physics. This could * range
 *from no effect, to exiting the edge of the world.                            *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This sets the speed of the projectile. It basically functions like a
 *throttle value      * where 0 equals stop and 255 equals maximum speed
 *(whatever that is for the particular    * object). *
 *                                                                                             *
 ...
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 07/26/1994 JLB : Created. * 07/26/1994 JLB : Added maximum speed
 *as guiding value.                                    *
 *=============================================================================================*/
void FlyClass::Fly_Speed(int speed, MPHType maximum) {
  SpeedAdd =
      static_cast<MPHType>(static_cast<int>(maximum) * fixed(speed, 256));
