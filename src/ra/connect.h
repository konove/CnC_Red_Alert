 ...
 * DATA_ACK & DATA_NOACK packets.  This ensures that the counter can be * used
 *to detect resends of DATA_ACK packets; the counters for DATA_NOACK * packets
 *aren't currently used.  Other counters keep track of the *
 * last-sequentially-received packet ID (for DATA_ACK packets), so we * can
 *check for resends & missed packets, and the last-sequentially-read	* packet
 *ID, so we can ensure the app reads the packets in order. *
 *                                                                         *
...
class ConnectionClass {
 ...
 protected:
  ...
  .....................................................................*/
  uint32_t LastReadID = 0xffffffff;
