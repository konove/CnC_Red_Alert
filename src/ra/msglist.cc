 ...
 *                                                                         *
 * INPUT:                                                                  *
 *    x,y			coord of upper-left of top message * max_msg
 *max messages allowed, including edit message          	*
 *                                                                         *
 * OUTPUT:                                                                 *
 *    none. *
 *                                                                         *
 ...
 ** maxchars			max # characters allowed per message * height
 *pixel height of a line of text
 ** edit_x			x-coord of edit field; -1 = put at the top of
 *the		* other messages
 ** edit_y			y-coord of edit field; -1 = put at the top of
 *the		* other messages
 ...
 * MessageListClass::Reset -- Reset so no messages are visible. *
 *                                                                                             *
 *    This routine will reset the message list tracker so that any displayed
 ...
 ** txt         text to display                                        	* color
 *color to draw text in                                		* style style to
 *use                                         		* timeout     # of ticks
 *the thing is supposed to last (-1 = forever)	*
 *                                                                         *
 * OUTPUT:                                                                 *
 ...
 *                                                                         *
 * WARNINGS:                                                               *
 *		If the required message doesn't exist, this routine does
 *nothing.		*
 *                                                                         *
 * HISTORY:                                                                *
 *   11/07/1995 BRR : Created.                                             *
...
/***********************************************************************************************
 * MessageListClass::Set_Edit_Focus -- Give the gadget system focus to the edit
 *box            *
 *                                                                                             *
 *                                                                                             *
 *                                                                                             *
...
/***********************************************************************************************
 * MessageListClass::Has_Edit_Focus -- Find out if the edit box has the input
 *focus            *
 *                                                                                             *
 *                                                                                             *
 *                                                                                             *
 ...
 *                                                                         *
 * INPUT:                                                                  *
 *    color			color of edit message * style
 *style of edit message                                		* to
 *string: who to send to; NULL = none
 ...
 *                                                                         *
 * OUTPUT:                                                                 *
 *    1 = caller should redraw the message list (no need to complete * refresh,
 *though)                                                 * 2 = caller should
 *completely refresh the display.                  	* 3 = caller should send
 *the edit message.                           	* (sets 'input' to 0 if it
 *processes it.)                          * 4 = caller should send the Overflow
 *buffer *
 *                                                                         *
 * WARNINGS:                                                               *
 *    none. *
 ...
 *                                                                         *
 * INPUT:                                                                  *
 *		dest				buffer to store removed
 *characters in; NULL = none		* src				text
 *buffer to trim
