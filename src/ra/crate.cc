 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * CrateClass::Create_Crate -- Create a crate in the cell
 *specified.                         * CrateClass::Get_Crate -- Pick up a crate
 *from the cell specified.                         * CrateClass::Put_Crate --
 ...
 *                                                                                             *
 *    This will create a crate in the cell specified. If the crate could not be
 *crated there   * then 'false' will be returned. *
 *                                                                                             *
 * INPUT:   cell  -- The desired cell to place the crate in. *
 *                                                                                             *
 * OUTPUT:  bool; Was the crate created and placed in the cell? *
 *                                                                                             *
 * WARNINGS:   It is quite possible for the crate not to have been placed. Only
 *the most clear * locations are valid for crate placement. *
 *                                                                                             *
 * HISTORY: * 08/26/1996 JLB : Created. *
 *=============================================================================================*/
bool CrateClass::Create_Crate(CELL cell) {
  ...
  */
  if (Put_Crate(cell)) {
    Cell = cell;
    CrateTimer.Set(Random_Pick(Rule.CrateTime * (TICKS_PER_MINUTE / 2),
 ...
 *                                                                                             *
 *    This helpter routine will examine the cell and place the appropriate crate
 *type into     * the cell specified. If the overlay could not be generated,
 ...
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 08/26/1996 JLB : Created. * 10/14/1996 JLB : Takes reference to
