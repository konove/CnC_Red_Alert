 ...
 **
 *                                                                         *
 * This format guarantees a unique version number for each compile (as * long as
 *they're a minute or more apart), with increasing version #'s		* for
 *later times.
 **
 *                                                                         *
 ...
 * which may contain a custom string (such as "Beta"); this string is * read
 ...
 * VersionClass::Init_Clipping -- Initializes version clipping             *
 *                                                                         *
 * Initializes the Min & Max clip version #'s to the min & max values * defined
 *for this program.  This sets the initial range for use by * the Clip_Version
 *routine.
 **
 *                                                                         *
 * INPUT:                                                                  *
