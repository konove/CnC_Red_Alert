 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * ProgressBarClass::Is_Horizontal -- Determines if the bargraph is
 *horizontal or not.       * ProgressBarClass::Outline -- Draw an outline around
 *the bargraph if supposed to.          * ProgressBarClass::ProgressBarClass --
 *Constructor for the bargraph object.                * ProgressBarClass::Redraw
 *-- Redraw the bargraph.                                          *
 ...
 *                                                                                             *
 *    This is the constructor for the bargraph object. It establishes the
 *dimensions and       * coordinate of the bargraph as well as the colors it
 *will use when drawn.                 *
 *                                                                                             *
 * INPUT:   w,y      -- Pixel coordinate of the upper left corner of the
 *bargraph.             *
 *                                                                                             *
 *          width,height   -- Dimensions of the bargraph. *
 *                                                                                             *
 *          forecolor   -- The color to use for the filled portion of the
 *bargraph.            *
 *                                                                                             *
 *          backcolor   -- The color to use for the non-filled portion of the
 *bargraph.        *
 *                                                                                             *
 *          bordercolor -- Optional border color. If not zero, then the bargraph
 *will be       * outlined with this color. *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   none *
 ...
 *=============================================================================================*/
ProgressBarClass::ProgressBarClass(int x, int y, int width, int height,
 ...
 * HISTORY: * 08/16/1996 JLB : Created. *
 *=============================================================================================*/
bool ProgressBarClass::Is_Horizontal() const { return Width > Height; }

/***********************************************************************************************
 * ProgressBarClass::Update -- Update the value and redraw as necessary. *
 *                                                                                             *
 *    This will update the value of the bargraph to the fill ratio specified and
 *then          * redraw it if required. Very small changes to the bargraph
 *value might not result in a    * visual change. *
 *                                                                                             *
...
/***********************************************************************************************
 * ProgressBarClass::Outline -- Draw an outline around the bargraph if supposed
 *to.            *
 *                                                                                             *
 *    This routine will draw a border around the bargraph if this bargraph has a
 *color         * specified for the border. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  none *
...
void ProgressBarClass::Redraw() const {
  ...
  */
  ...
  LastDisplayCurrent = CurrentValue;
  IsDrawn = true;
}
