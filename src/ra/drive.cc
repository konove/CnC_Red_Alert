...
bool DriveClass::Teleport_To(CELL cell) {
  ...
  */
  if (What_Am_I() == RTTI_UNIT &&
    ...
    HouseClass::As_Pointer(dynamic_cast<UnitClass*>(this)->Flagged)
...
COORDINATE DriveClass::Smooth_Turn(COORDINATE adj, DirType& dir) {
  ...
  return XY_Coord(static_cast<LEPTON>(Coord_X(Head_To_Coord()) + x),
                  static_cast<LEPTON>(Coord_Y(Head_To_Coord()) + y));
}
