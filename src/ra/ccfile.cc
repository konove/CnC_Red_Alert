 ...
 *   CCFileClass::Close -- Closes the file. * CCFileClass::Error -- Handles
 *displaying a file error message.                            *
 *   CCFileClass::Is_Available -- Checks for existence of file on disk or in
 *mixfile.          * CCFileClass::Is_Open -- Determines if the file is open. *
 *   CCFileClass::Open -- Opens a file from either the mixfile system or the
 *rawfile system.   * CCFileClass::Read -- Reads data from the file. *
