 ...
 *                                                                         *
 *-------------------------------------------------------------------------*
 * Functions: * NonSequencedConnClass::NonSequencedConnClass -- class
 *constructor     * NonSequencedConnClass::~NonSequencedConnClass -- class
 *destructor     * NonSequencedConnClass::Init -- Initializes connection queue
 *to empty	* NonSequencedConnClass::Send_Packet -- adds a packet to the
 *send queue	* NonSequencedConnClass::Receive_Packet -- adds packet to
 *receive queue	* NonSequencedConnClass::Get_Packet -- gets a packet from
 *receive queue	* NonSequencedConnClass::Service_Send_Queue -- services the send
 *queue	* NonSequencedConnClass::Service_Receive_Queue -- services recieve
 *queue*
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
...
int NonSequencedConnClass::Send_Packet(void* buf, int buflen, int ack_req) {
  ...
  ........................................................................*/
  static_cast<CommHeaderType*>(PacketBuf)->MagicNumber = MagicNum;
  ...
  ........................................................................*/
  if (ack_req) {
    static_cast<CommHeaderType*>(PacketBuf)->Code = PACKET_DATA_ACK;
    static_cast<CommHeaderType*>(PacketBuf)->PacketID = NumSendAck;
  } else {
    static_cast<CommHeaderType*>(PacketBuf)->Code = PACKET_DATA_NOACK;
    static_cast<CommHeaderType*>(PacketBuf)->PacketID = NumSendNoAck;
  }
 ...
 *CommHeaderType)			* buflen	length of buffer to
 *process
 **
 *                                                                         *
 * OUTPUT:                                                                 *
    ...
    for (i = 0; i < Queue->Num_Send(); i++) {
      ...
      */
      if (send_entry != nullptr) {
        entry_data = static_cast<CommHeaderType*>(send_entry->Buffer);
        /*
  ...
  ------------------------------------------------------------------------*/
    ...
    ....................................................................*/
      ...
      for (i = 0; i < Queue->Num_Receive(); i++) {
        ...
        if (rec_entry) {
          entry_data = static_cast<CommHeaderType*>(rec_entry->Buffer);
          /*...........................................................
    ...
    Send(static_cast<char*>(&ackpacket), sizeof(CommHeaderType));
  ...
  for (i = 0; i < Queue->Num_Send(); i++) {
    ...
    */
    if (send_entry->IsACK) {
      ...
      */
      packet_hdr = static_cast<CommHeaderType*>(send_entry->Buffer);
...
int NonSequencedConnClass::Service_Receive_Queue() {
  ...
  for (i = 0; i < Queue->Num_Receive(); i++) {
    ...
    if (rec_entry->IsRead) {
      packet_hdr = static_cast<CommHeaderType*>(rec_entry->Buffer);
