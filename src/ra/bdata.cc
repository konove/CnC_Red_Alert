 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * BuildingTypeClass::As_Reference -- Fetches reference to the
 *building type specified.      * BuildingTypeClass::Bib_And_Offset --
 *Determines the bib and appropriate cell offset.      *
 *   BuildingTypeClass::BuildingTypeClass -- This is the constructor for the
 *building types.   * BuildingTypeClass::Coord_Fixup -- Adjusts coordinate to be
 *legal for assignment.          * BuildingTypeClass::Cost_Of -- Fetches the
 *cost of this building.                          *
 *   BuildingTypeClass::Create_And_Place -- Creates and places a building object
 *onto the map. * BuildingTypeClass::Create_One_Of -- Creates a building of this
 *type.                      * BuildingTypeClass::Dimensions -- Fetches the
 *pixel dimensions of the building.            * BuildingTypeClass::Display --
 *Renders a generic view of building.                         *
 *   BuildingTypeClass::Flush_For_Placement -- Tries to clear placement area for
 *this building * BuildingTypeClass::Full_Name -- Fetches the name to give this
 *building.                   * BuildingTypeClass::Height -- Determines the
 *height of the building in icons.              * BuildingTypeClass::Init --
 *Performs theater specific initialization.                      *
 *   BuildingTypeClass::Init_Anim -- Initialize an animation control for a
 *building.           * BuildingTypeClass::Init_Heap -- Initialize the heap as
 *necessary for the building type obj* BuildingTypeClass::Max_Pips -- Determines
 *the maximum pips to display.                    *
 *   BuildingTypeClass::Occupy_List -- Fetches the occupy list for the building.
 ** BuildingTypeClass::One_Time -- Performs special one time action for
 *buildings.            * BuildingTypeClass::Overlap_List -- Fetches the overlap
 *list for the building.             * BuildingTypeClass::Prep_For_Add --
 *Prepares scenario editor for adding an object.         *
 *   BuildingTypeClass::Raw_Cost -- Fetches the raw (base) cost of this building
 *type.         * BuildingTypeClass::Read_INI -- Fetch building type data from
 *the INI database.            * BuildingTypeClass::Width -- Determines width of
 *building in icons.                        * BuildingTypeClass::operator delete
 *-- Deletes a building type object from the special heap*
 *   BuildingTypeClass::operator new -- Allocates a building type object from
 *the special heap.*
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
static const int16_t ExitSub[] = {XYCELL(0, 2), XYCELL(2, 2), XYCELL(-1, 2),
                                  XYCELL(1, 2), XYCELL(3, 2)};

static const int16_t ExitWeap[] = {XYCELL(1, 2), XYCELL(-1, 3), XYCELL(0, 3),
                                   XYCELL(1, 3), XYCELL(-2, 3), XYCELL(2, 3),
                                   kRefreshEol};

static const int16_t ComList[] = {0, 1, MCW, MCW + 1, kRefreshEol};
static const int16_t List000111111[] = {
    (MCW * 1),     (MCW * 1) + 1, (MCW * 1) + 2, (MCW * 2),
    (MCW * 2) + 1, (MCW * 2) + 2, kRefreshEol};
static const int16_t List0010[] = {MCW, kRefreshEol};
static const int16_t List0011[] = {(MCW * 1), (MCW * 1) + 1, kRefreshEol};
static const int16_t List010111100[] = {
    1, (MCW * 1), (MCW * 1) + 1, (MCW * 1) + 2, (MCW * 2), kRefreshEol};
static const int16_t List0111[] = {1, (MCW * 1), (MCW * 1) + 1, kRefreshEol};
static const int16_t List1000[] = {0, kRefreshEol};
static const int16_t List101000011[] = {0, 2, (MCW * 2) + 1, (MCW * 2) + 2,
                                        kRefreshEol};
static const int16_t List1100[] = {0, 1, kRefreshEol};
static const int16_t List1101[] = {0, 1, (MCW * 1) + 1, kRefreshEol};
static const int16_t List11[] = {0, 1, kRefreshEol};
static const int16_t List12[] = {MCW, kRefreshEol};
static const int16_t List1[] = {0, kRefreshEol};
static const int16_t List21[] = {0, 1, kRefreshEol};
static const int16_t List22[] = {0, 1, MCW, MCW + 1, kRefreshEol};
static const int16_t List22_0011[] = {MCW, MCW + 1, kRefreshEol};
static const int16_t List22_1100[] = {0, 1, kRefreshEol};
static const int16_t List2[] = {0, 1, MCW + 1, MCW, kRefreshEol};
static const int16_t List32[] = {0, 1, 2, MCW, MCW + 1, MCW + 2, kRefreshEol};
...
static const int16_t ListWeap[] = {
    0, 1, 2, (MCW * 1), (MCW * 1) + 1, (MCW * 1) + 2, kRefreshEol};
static const int16_t ListWestwood[] = {1,       2,       3,          MCW + 1,
                                       MCW + 2, MCW + 3, kRefreshEol};
static const int16_t OListSAM[] = {-MCW, -(MCW - 1), kRefreshEol};
#ifdef FATSHIP
static const int16_t ListSPen[] = {0,
                                   1,
                                   2,
                                   MCW,
                                   MCW + 1,
...
static const int16_t ListFactory[] = {0,
                                      1,
                                      2,
                                      (MCW * 1),
                                      (MCW * 1) + 1,
...
static const int16_t OListFix[] = {0, 2, MCW + MCW, MCW + MCW + 2, kRefreshEol};
static const int16_t OListWeap[] = {kRefreshEol};
static const int16_t OComList[] = {1, kRefreshEol};
static const int16_t OList12[] = {0, kRefreshEol};
static const int16_t OListTmpl[] = {0, 1, 2, kRefreshEol};

/***************************************************************************
 */
static const BuildingTypeClass ClassBarrel(
    STRUCT_BARREL,
...
static const BuildingTypeClass ClassBarrel3(
    STRUCT_BARREL3,
    TXT_BARREL,       // NAME:			Short name of the structure.
...
static const BuildingTypeClass ClassAVMine(
    STRUCT_AVMINE,
...
static const BuildingTypeClass ClassAPMine(
    STRUCT_APMINE,
...
static const BuildingTypeClass ClassIronCurtain(
    STRUCT_IRON_CURTAIN,
...
static const BuildingTypeClass ClassForwardCom(
    STRUCT_FORWARD_COM,
...
static const BuildingTypeClass ClassAdvancedTech(
    STRUCT_ADVANCED_TECH,
    TXT_ADVANCED_TECH,  // NAME:			Short name of the
                        // structure.
...
static const BuildingTypeClass ClassChronosphere(
    STRUCT_CHRONOSPHERE,
...
static const BuildingTypeClass ClassShipYard(
    STRUCT_SHIP_YARD,
...
static const BuildingTypeClass ClassSubPen(
    STRUCT_SUB_PEN,
...
static const BuildingTypeClass ClassPillbox(
    STRUCT_PILLBOX,
...
static const BuildingTypeClass ClassCamoPillbox(
    STRUCT_CAMOPILLBOX,
...
static const BuildingTypeClass ClassTesla(
    STRUCT_TESLA,
...
static const BuildingTypeClass ClassAAGun(
    STRUCT_AAGUN,
...
static const BuildingTypeClass ClassFlameTurret(
    STRUCT_FLAME_TURRET,
...
static const BuildingTypeClass ClassFakeConst(
    STRUCT_FAKECONST,
...
static const BuildingTypeClass ClassFakeWeapon(
    STRUCT_FAKEWEAP,
...
static const BuildingTypeClass ClassGapGenerator(
    STRUCT_GAP,
    TXT_GAP_GENERATOR,  // NAME:			Short name of the
                        // structure.
...
static const BuildingTypeClass ClassMissileSilo(
    STRUCT_MSLO,
...
static const BuildingTypeClass ClassSovietTech(
    STRUCT_SOVIET_TECH,
...
static const BuildingTypeClass ClassTent(
    STRUCT_TENT,
    TXT_BARRACKS,       // NAME:			Short name of the structure.
...
static const BuildingTypeClass ClassKennel(
    STRUCT_KENNEL,
...
static const BuildingTypeClass ClassFakeShipYard(
    STRUCT_FAKE_YARD,
...
static const BuildingTypeClass ClassFakeSubPen(
    STRUCT_FAKE_PEN,
...
static const BuildingTypeClass ClassFakeCommand(
    STRUCT_FAKE_RADAR,
...
static const BuildingTypeClass Fence(
    STRUCT_FENCE,
...
static const BuildingTypeClass ClassQueen(
    STRUCT_QUEEN,
...
static const BuildingTypeClass ClassLarva1(
    STRUCT_LARVA1,
    TXT_NONE,         // NAME:			Short name of the structure.
...
static const BuildingTypeClass ClassLarva2(
    STRUCT_LARVA2,
    TXT_NONE,         // NAME:			Short name of the structure.
...
BuildingTypeClass::BuildingTypeClass(
    ...
    std::span<const int16_t> exitlist, std::span<const int16_t> sizelist,
...
/***********************************************************************************************
 * BuildingTypeClass::operator new -- Allocates a building type object from the
 *special heap.  *
 *                                                                                             *
 *    This routine will allocate a building type object from the special heap
 *used just for    * allocation of object of this type. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the newly allocated object. If the
 *allocation could not  * succeed, then nullptr will be returned. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
...
/***********************************************************************************************
 * BuildingTypeClass::operator delete -- Deletes a building type object from the
 *special heap. *
 *                                                                                             *
 *    This will delete a previously allocated building type object. The memory
 *is returned     * to the special heap that is used for that purpose. *
 *                                                                                             *
 * INPUT:   ptr   -- Pointer to the building type object to return to the
 *special heap.        *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
...
/***********************************************************************************************
 * BuildingTypeClass::Init_Heap -- Initialize the heap as necessary for the
 *building type obje *
 *                                                                                             *
 *    This routine performs the necessary heap initializations. Since we know
 *exactly what     * building type objects will be needed, they are
 *pre-allocated at this time.               *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  none *
 ...
 *buildings.              *
 *                                                                                             *
 *    This routine is used to do the one time action necessary to handle
 *building type class   * objects. This entails loading of the building shapes
 *and the brain file used by          * buildings. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  none *
  ...
  for (const StructType sindex : magic_enum::enum_values<StructType>()) {
    ...
    */
    if (building.Level != -1) {
      ...
      building.CameoData = MixArchive::RetrieveData(fullname);
    }
    ...
    */
    auto fullname =
        std::filesystem::path(std::string(building.Graphic_Name()) + "MAKE")
            ...
            .string();
    const auto dataptr = MixArchive::RetrieveData(fullname);
 ...
 *                                                                                             *
 *    This routine will convert an ASCII name for a building class into * the
 *actual building class it represents. *
 *                                                                                             *
 ...
 *                                                                                             *
 *          window   -- The window the building should be rendered * relative
 *to.                                                           *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine is used to prepare the scenario editor for the addition * of
 *a building object to the game. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  none *
 ...
 *onto the map.   *
 *                                                                                             *
 *    This routine is used by the scenario editor to create and place buildings
 *on the map.    *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine will create a building object of this type. The building
 *object is in a     * limbo state. It is presumed that the building object will
 *be unlimboed at the correct    * place and time. Typical use is when the
 *building is created in a factory situation       * and will be placed on the
 *map when construction completes.                               *
 *                                                                                             *
 * INPUT:   house -- Pointer to the house that is to be the owner of the
 *building.             *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the building. If the building could not be
 *created       * then a nullptr is returned. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *    specified building. This modifies a "const" class and thus must * perform
 *some strategic casting to get away with this. *
 *                                                                                             *
 ...
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 04/18/1994 JLB : Created. *
 *=============================================================================================*/
 ...
 *                                                                                             *
 *    This routine is used to perform any initialization that is custom per
 *theater.           * Typically, this is fetching the building shape data for
 *those building types that have   * theater specific art. *
 *                                                                                             *
...
/***********************************************************************************************
 * BuildingTypeClass::Dimensions -- Fetches the pixel dimensions of the
 *building.              *
 *                                                                                             *
 *    This routine will fetch the dimensions of the building (in pixels). These
 *dimensions are * used to render the selection rectangle and the health bar. *
 *                                                                                             *
...
/***********************************************************************************************
 * BuildingTypeClass::As_Reference -- Fetches reference to the building type
 *specified.        *
 *                                                                                             *
 *    This routine will fetch a reference to the BuildingTypeClass as indicated
 *by the         * building type number specified. *
 *                                                                                             *
 * INPUT:   type  -- The building type number to convert into a
 *BuildingTypeClass reference.   *
 *                                                                                             *
 * OUTPUT:  Returns with a reference to the building type class as indicated by
 *the            * parameter. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 * BuildingTypeClass::Occupy_List -- Fetches the occupy list for the building. *
 *                                                                                             *
 *    Use this routine to fetch the occupy list pointer for the building. The
 *occupy list is   * used to determine what cells the building occupies and thus
 *precludes other buildings    * or objects from using. *
 *                                                                                             *
 * INPUT:   placement   -- Is this for placement legality checking only? The
 *normal condition  * is for marking occupation flags. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to a cell offset list to be used to determine
 *what cells    * this building occupies. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 01/23/1995 JLB : Created. *
 *=============================================================================================*/
std::span<const int16_t> BuildingTypeClass::Occupy_List(bool placement) const {
  ...
  if (placement && Bib_And_Offset(bib, cell)) {
    ...
    std::span<int16_t> dest(_list);

    /*
    **	Copy the bib overlap list into the working buffer.
    */
    std::span<const int16_t> src = smudge.Occupy_List();
    while (src.front() != kRefreshEol) {
      base::ConsumeFront(dest) =
          static_cast<int16_t>(base::ConsumeFront(src) + cell);
    }
    ...
    */
    src = OccupyList;
    while (!src.empty() && src.front() != kRefreshEol) {
      base::ConsumeFront(dest) = base::ConsumeFront(src);
    }
    dest.front() = kRefreshEol;
  ...
  static const int16_t _templap[] = {kRefreshEol};
  return _templap;
}
 ...
 **
 *                                                                                             *
 *    This routine will fetch the overlap list for the building. The overlap
 *list is used      * to determine what cells the building's graphics cover, but
 *is not considered to occupy   * for movement purposes. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the cell offset list that is used to
 *determine the       * cells that this building overlaps. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 01/23/1995 JLB : Created. *
 *=============================================================================================*/
std::span<const int16_t> BuildingTypeClass::Overlap_List() const {
 ...
 *offset.        *
 *                                                                                             *
 *    This routine is used to determine what (if any) bib should be used for
 *this building     * and also the cell offset for the upper left corner of the
 *bib smudge type.               *
 *                                                                                             *
 * INPUT:   bib   -- Reference to the bib that should be used for this building.
 **
 *                                                                                             *
 *          cell  -- The cell offset for the upper left corner of the bib. This
 *offset is      * relative to the upper left corner of the building. *
 *                                                                                             *
 * OUTPUT:  Is a bib required for this building? If the result is true, then the
 *correct       * bib and cell offset will be filled in. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    Use this routine to determine the maximum number of pips to display on
 *this building     * when it is rendered. Typically, this is the tiberium
 *capacity divided by 100.            *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  Returns with the number of pips to display on this building when
 *selected.         *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *type.           *
 *                                                                                             *
 *    This routine is used to fetch the real raw base cost of the building. The
 *raw cost       * is the cost of the building less any free unit that would
 *come with the building         * if it were built in the normal fashion.
 *Specifically, the helicopter cost is subtracted  * from the helipad and the
 *harvester cost is subtracted from the refinery. This cost       * is used for
 *refunding.                                                                   *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 ...
 *this building t *
 *                                                                                             *
 *    This routine is called when a clear space for placement is desired at the
 *cell location  * specified. Typical use of this routine is by the computer
 *when it wants to build up      * its base. *
 *                                                                                             *
 * INPUT:   cell  -- The cell that the building of this type would like to be
 *placed down at.  *
 *                                                                                             *
 *          house -- Pointer to the house that want to clear the foundation
 *zone.              *
 *                                                                                             *
 ...
 *=============================================================================================*/
bool BuildingTypeClass::Flush_For_Placement(CELL cell,
                                            HouseClass* house) const {
  bool again = false;
  if (cell > 0) {
    std::span<const int16_t> list = Occupy_List(true);
...
/***********************************************************************************************
 * BuildingTypeClass::Read_INI -- Fetch building type data from the INI
 *database.              *
 *                                                                                             *
 *    This routine will fetch the building type class data from the INI database
 *file.         *
 *                                                                                             *
...
/***********************************************************************************************
 * BuildingTypeClass::Coord_Fixup -- Adjusts coordinate to be legal for
 *assignment.            *
 *                                                                                             *
 *    This routine will adjust the specified coordinate so that it will be legal
 *for assignment* to this building. All buildings are given a coordinate that is
 *in the upper left corner  * of a cell. This routine will drop the fractional
 ...
 *                                                                                             *
 * WARNINGS:   The coordinate is not examined to see if the cell is legal for
 *placing the      * building. It merely adjusts the coordinate so that is legal
 *at first glance.    *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine will return the displayable given name for this building
 *type. Normally,    * this is the official name as well, however in the case of
 *civilian buildings, the        * name will just be "Civilian Building" unless
 *special options are in place.               *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
