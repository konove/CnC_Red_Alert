 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * BulletTypeClass::As_Reference -- Returns with a reference to the
 *bullet type object specif* BulletTypeClass::BulletTypeClass -- Constructor for
 *bullet type objects.                  * BulletTypeClass::Init_Heap --
 *Initialize the heap objects for the bullet type.            *
 ...
 ** BulletTypeClass::Read_INI -- Fetch the bullet type data from the INI
 *database.            * BulletTypeClass::operator delete -- Deletes a bullet
 *type object from the special heap.   * BulletTypeClass::operator new --
 *Allocates a bullet type object from the special heap.    *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *                                                                                             *
 *    This is basically a constructor for static type objects used by bullets.
 *All bullets     * are of a type constructed by this routine at game
 *initialization time.                   *
 *                                                                                             *
 * INPUT:   see below... *
 *                                                                                             *
 ...
 *special heap.      *
 *                                                                                             *
 *    This allocates a bullet type object from a special heap that is used just
 *for            * objects of this type. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to an allocated block or NULL if the
...
/***********************************************************************************************
 * BulletTypeClass::operator delete -- Deletes a bullet type object from the
 *special heap.     *
 *                                                                                             *
 *    This is the counterpart to the operator new function for bullet type
 *objects. It will    * return the bullet type object back to the special heap
 *used for bullet type object       * allocation. *
 *                                                                                             *
...
/***********************************************************************************************
 * BulletTypeClass::Init_Heap -- Initialize the heap objects for the bullet
 *type.              *
 *                                                                                             *
 ...
 * BulletTypeClass::One_Time -- Performs the one time processing for bullets. *
 *                                                                                             *
 *    This routine is used to perform any one time processing for the bullet
 *type class. It    * handles loading of the shape files. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   This routine must be called before any rendering of bullets
 *occurs and should   * only be called once. *
 *                                                                                             *
...
/***********************************************************************************************
 * BulletTypeClass::As_Reference -- Returns with a reference to the bullet type
 *object specifi *
 *                                                                                             *
 *    Given a bullet type identifier, this routine will return a reference to
 *the bullet type  * object it refers to. *
 *                                                                                             *
 * INPUT:   type  -- The bullet type identifier to convert to a reference. *
 *                                                                                             *
 * OUTPUT:  Returns with a reference to the bullet type object. *
 *                                                                                             *
 * WARNINGS:   Make sure that the type parameter specified is a valid bullet
 *type. If not,     * then the results are undefined. *
 *                                                                                             *
 * HISTORY: * 07/06/1996 JLB : Created. *
 *=============================================================================================*/
 ...
 *database.              *
 *                                                                                             *
 *    Use this routine to fetch override information about this bullet type
