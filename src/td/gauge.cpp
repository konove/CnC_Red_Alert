...
/* $Header:   F:\projects\c&c\vcs\code\gauge.cpv   2.19   16 Oct 1995 16:50:56
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * GaugeClass::Action -- Handles input events for the gauge. *
 ...
 * GaugeClass::Set_Maximum -- Sets the maximum value for the gauge. *
 *                                                                                             *
 *    This routine will set the maximum value for the gauge. This is the largest
 *value that    * the current setting may reach. The ability to change this
 *allows the guage to use and    * return values that are convenient for the
 *programmer's current needs.                    *
 *                                                                                             *
 * INPUT:   value -- The value to use as the gauge maximum. *
 *                                                                                             *
 * OUTPUT:  bool; Was the gauge maximum changed? A false indicates that the
 *specified value    * already matches the current maximum. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 * GaugeClass::Set_Value -- Set the value of the gauge. *
 *                                                                                             *
 *    This routine will set the current value for the gauge. This value is
 *clipped to the      * limits of the gauge maximum. *
 *                                                                                             *
 * INPUT:   value -- The value to set at the new current value. *
 *                                                                                             *
 * OUTPUT:  bool; Was the current setting changed? A false indicates that the
 *setting          * specified is the same as what was already there. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 01/16/1995 JLB : Created. *
 ...
 * GaugeClass::Pixel_To_Value -- Convert a pixel offset into a gauge value. *
 *                                                                                             *
 *    Use this routine to conver the specified pixel offset into a gauge value.
 *This is used   * in translating mouse clicks into a cooresponding setting for
 *the guage.                  *
 *                                                                                             *
 ...
 * GaugeClass::Value_To_Pixel -- Convert gauge value to pixel offset. *
 *                                                                                             *
 *    Use this routine to convert the specified gauge value into a pixel offset
 *from the       * star of the gauge. This is used for thumb positioning. *
 *                                                                                             *
 * INPUT:   value -- The value to convert to a pixel offset. *
 *                                                                                             *
 * OUTPUT:  Returns with the pixel offset of the specified value from the start
 *of the         * guage. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine will handle input event processing for the gauge. It will
 *adjust the        * current setting of the gauge according to the mouse
 *position.                            *
 *                                                                                             *
 * INPUT:   flags -- The input event that is the reason for this function call.
 ** key   -- The key code that caused the event. *
 *                                                                                             *
 * OUTPUT:  bool; Was the even recognized, processed, and no further gadget
 *scanning is        * desird (for this pass). *
 *                                                                                             *
  ...
  if (flags & LEFTPRESS || (flags & LEFTHELD && StuckOn == this)) {
    ...
    */
    if (flags & LEFTPRESS) {
      ...
      int testval = Pixel_To_Value(IsHorizontal ? Get_Mouse_X() - ClickDiff
...
/***********************************************************************************************
 * TriColorGaugeClass::Set_Yellow_Limit -- Set the value for the yellow area of
 *gauge.         *
 *                                                                                             *
 * INPUT:      int value. *
 *                                                                                             *
