...
/* $Header:   F:\projects\c&c\vcs\code\idata.cpv   2.12   02 Aug 1995 17:00:30
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * InfantryTypeClass::Create_And_Place -- Creates and places
 *infantry object onto the map.   * InfantryTypeClass::Create_One_Of -- Creates
 *an infantry object.                           * InfantryTypeClass::Display --
 *Displays a generic infantry object.                         *
 ...
 *objects.      * InfantryTypeClass::Occupy_List -- Returns with default
 *infantry occupation list.          * InfantryTypeClass::One_Time -- Performs
 *any one time processing for infantry system.      *
 *   InfantryTypeClass::Prep_For_Add -- Prepares the scenario editor for adding
 *of infantry object.* InfantryTypeClass::Who_Can_Build_Me -- Determines what
 *can build the infantry object.     *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 * pointer to the table to the constructor instead of passing each value as it
 * was before.
 *
 * If this offends anyones C++ sensibilities then please feel free to implement
 * a more elegant oop solution.
 *
...
/***********************************************************************************************
 * InfantryTypeClass::Who_Can_Build_Me -- Determines what can build the infantry
 *object.       *
 *                                                                                             *
 *    Use this routine to determine what building can produce the infantry
 *object. This is     * typically used to maintain the construction list
 *sidebar.                                *
 *                                                                                             *
 * INPUT:   intheory -- If no regard is to be given to whether the construction
 *building is    * currently busy, then this flag should be true. In such a
 *case, only    * the existance of the building is sufficient to achieve
 *success.        *
 *                                                                                             *
 ...
 *                                                                                             *
 *          house    -- The house of the infantry to be produced. Only
 *construction buildings  * of the same house are considered. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the object (building) that can produce the
 *infantry      * type. If there are no available buildings then the return
 *value is NULL.           *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
