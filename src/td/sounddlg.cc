...
/* $Header:   F:\projects\c&c\vcs\code\sounddlg.cpv   2.17   16 Oct 1995
 * 16:51:32   JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * SoundControlsClass::Process -- Handles all the options graphic
 *interface.                 *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
void SoundControlsClass::Process() {
  ...
  */
  for (ThemeType index = THEME_AIRSTRIKE; index < Theme.Max_Themes(); index++) {
