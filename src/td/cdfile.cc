...
/* $Header:   F:\projects\c&c\vcs\code\cdfile.cpv   2.18   16 Oct 1995 16:48:10
 * JOE_BOSTIC  $ */
/***********************************************************************************************
...
void CDFileClass::AddSearchPath(char* path) {
 ...
 * HISTORY: * 10/18/1994 JLB : Created. *
 *=============================================================================================*/
void CDFileClass::ClearSearchPaths() {
  ...
  */
  ...
  while (srch) {
    ...
    */
    ...
    /*
    **	Check to see if the file could be found. The low level IsAvailable
 ...
 *still couldn't be found, then it is opened     * using the normal RawFileClass
 *system -- resulting in normal error procedures.            *
 *                                                                                             *
