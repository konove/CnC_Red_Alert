...
/* $Header:   F:\projects\c&c\vcs\code\anim.cpv   2.18   16 Oct 1995 16:48:48
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *   AnimClass::Adjust_Coord -- Adjusts anim coordinates * AnimClass::AnimClass
 *-- The constructor for animation objects.                            *
 ...
 *   AnimClass::In_Which_Layer -- Determines what render layer the anim should
 *be in.          * AnimClass::Init -- Performs pre-scenario initialization. *
 ...
 *   AnimClass::~AnimClass -- Destructor for anim objects. * AnimClass::Validate
 *-- validates anim pointer
  ...
  if (Delay) {
    ...
    */
    ...
    if (Graphic_Logic()) {
      ...
      */
      if (Object && Class->Damage) {
        ...
        if (accum > 255) {
          ...
          */
          int damage = accum >> 8;
          if (Object->Take_Damage(damage, 0, WARHEAD_FIRE) ==
              RESULT_DESTROYED) {
            // Object = 0;
            delete this;
            return;
      ...
      *existance while in plain sight.
      */
...
void AnimClass::Start() {
  ...
  *animation, then *	perform this action now. Subsiquent checks against this
  ...
  */
  ...
  /*
  **	If this is the kind of animation that sticks to whatever object is in
...
void AnimClass::Middle() {
  ...
  */
  ...
  /*
  **	Flame throwers leave scorch marks in unusual positions. In addition,
  *they leave fire *	shards in unusual positions as well.
  */
 ...
 * AnimClass::As_Target -- Converts the animation into a target value. *
 *                                                                                             *
 *    This support routine is used to convert the animation (as a pointer) into
 *a target       * value (which is a number). *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
