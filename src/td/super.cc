...
/* $Header:   F:\projects\c&c\vcs\code\super.cpv   1.5   16 Oct 1995 16:49:04
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *is used for   * both the normal super weapons and the speicial one-time super
 *weapons (from crates).     *
 *                                                                                             *
 ...
 *to intelligenly update the sidebar.       *
 *                                                                                             *
...
int SuperClass::Anim_Stage() const {
  if (IsPresent) {
    ...
    return Fixed_To_Cardinal(
        kAnimationStages, Cardinal_To_Fixed(RechargeTime, RechargeTime - time));
  }
  return 0;
}
