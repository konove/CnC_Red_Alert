...
/* $Header:   F:\projects\c&c\vcs\code\textbtn.cpv   2.18   16 Oct 1995 16:49:16
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * TextButtonClass::Draw_Background -- Draws the background to the
 *text button.              * TextButtonClass::Draw_Me -- Draws the text buttons
 *as indicated.                          * TextButtonClass::Draw_Text -- This
 *draws the text for the text button.                    *
 ...
 *string pointer.    *
 *                                                                                             *
 * INPUT:   id    -- The ID number to assign to this button. * text  -- Pointer
 *to the text string to display on top of the button.               * x,y   --
 *Pixel coordinate of button's upper left corner.                           *
 ...
 *button.        * style -- The print style for the text in the button. These
 *are the TPF_ flags      * used by Fancy_Text_Print(). * border-- If the button
 *is to be surrounded by a black border, then this flag       * should be set to
 *true.                                                    *
 *                                                                                             *
 * OUTPUT:   none * WARNINGS: Call Set_Text & Set_Style, & init
 *X,Y,Width,Height,ID before using this button.	  * HISTORY:  01/15/1995 JLB :
 *Created.                                                         *
 *=============================================================================================*/
 ...
 *                                                                                             *
 *          border-- If the button is to be surrounded by a black border, then
 ...
 *function it   * is possible to dynmaically change the button's text. An
 ...
 * TextButtonClass::Set_Text -- Sets the text for this text button. *
 *                                                                                             *
 *    This will set the text for this button. The text is provided as a text
 *number. This      * number is automatically converted to the appropriate text
 *string before being stored     * in the button's structure. *
 *                                                                                             *
 * INPUT:   text  -- The text number to assign to this button. *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   The text number information is lost when it is assigned to the
 *button. Once     * the assignment takes place, the text number is NOT
 *remembered by the button.    * Only the associated text string is. *
 *                                                                                             *
 * HISTORY: * 01/16/1995 JLB : Created. *
 *=============================================================================================*/
