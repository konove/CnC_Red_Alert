...
/* $Header:   F:\projects\c&c\vcs\code\monoc.cpv   2.13   16 Oct 1995 16:50:36
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *object.             * MonoClass::operator = -- Handles making one mono object
 *have the same imagery as another. * MonoClass::Print -- Prints the text string
 *at the current cursor coordinates.             * MonoClass::Printf -- Prints a
 *formatted string to the monochrome screen.                  *
 ...
 *the coordinates specified.         * MonoClass::Text_Print -- Prints text to
 *the monochrome object at coordinates indicated.   * MonoClass::View -- Brings
 *the mono object to the main display.                            *
...
void Mono_Draw_Rect(int x, int y, int w, int h, int attrib, int thick) {
  if (MonoClass::Is_Enabled()) {
    ...
    mono->Draw_Box(x, y, w, h, static_cast<char>(attrib),
