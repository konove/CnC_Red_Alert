...
/* $Header:   F:\projects\c&c\vcs\code\mission.cpv   2.18   16 Oct 1995 16:49:12
 * JOE_BOSTIC  $ */
/***********************************************************************************************
...
int MissionClass::Mission_Timed_Hunt() { return TICKS_PER_SECOND * 30; };
 ...
 *under. The    * mission queue may be filled with a immanent mission change,
 ...
 * MissionClass::Assign_Mission -- Give an order to a unit. *
 *                                                                                             *
 *    This assigns an order to a unit. It does NOT do the AI, but merely * flags
 *the unit for normal AI processing. At that time the computer * will determine
 *the unit's course of action.                                              *
 *                                                                                             *
 ...
 *                                                                                             *
 *                                                                                             *
 * INPUT:      MissionType mission - the mission we want to overide * TARGET
 *tarcom  - the new target we want to overide                       * TARGET
 *navcom  - the new navigation point to overide                     *
 *                                                                                             *
 * OUTPUT:      none *
 *                                                                                             *
 * WARNINGS:   If a mission is already overidden, the current mission is * just
 *re-assigned.                                                             *
 *                                                                                             *
