...
/* $Header:   F:\projects\c&c\vcs\code\rawfile.h_v   2.16   16 Oct 1995 16:45:46
 * JOE_BOSTIC  $ */
/***********************************************************************************************
...
EZERO,                 // Non-error.
  ...
  *less.
  */
  long Transfer_Block_Size() { return (long)(UINT_MAX) - 16L; }
...
or filename    *
 *    associated with it. In order to use a file object created in this fashion
it must be     *
