...
/* $Header:   F:\projects\c&c\vcs\code\cargo.cpv   2.18   16 Oct 1995 16:49:50
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *    This routine will add the specified unit to the cargo hold. The * unit
 *will chain to any existing units in the hold. The chaining is * in a LIFO
 *order. *
 *                                                                                             *
...
void CargoClass::Attach(FootClass* object) {
  ...
  */
  ...
  /*
  **	Attach any existing cargo hold object to the end of the list as
  *indicated by the *	object pointer passed into this routine. This is
  *necessary because several objects may *	be attached at one time or
  ...
  */
  ...
  /*
  **	Finally, assign the object pointer as the first object attached to this
  *cargo hold.
  */
  CargoHold = object;
  Quantity = 0;
 ...
 * CargoClass::Attached_Object -- Determine attached unit pointer. *
 *                                                                                             *
 *    This routine will return with a pointer to the attached unit if one * is
 *present. One would need to know this if this is a transport * unit and it
 *needs to unload.                                                             *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
