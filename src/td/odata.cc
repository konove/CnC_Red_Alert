...
/* $Header:   F:\projects\c&c\vcs\code\odata.cpv   2.16   16 Oct 1995 16:50:36
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * OverlayTypeClass::Display -- Displays a generic representation
 *of overlay.                * OverlayTypeClass::From_Name -- Determine overlay
 *from ASCII name.                         * OverlayTypeClass::Init -- Loads
 *graphic data for overlays.                                *
 ...
 *overlay type.                * OverlayTypeClass::OverlayTypeClass --
 *Constructor for overlay type objects.               *
 ...
 *data.         * OverlayTypeClass::Init -- Initialize the overlay graphic data
 *per theater.                * OverlayTypeClass::Radar_Icon -- Gets a pointer
 *to the radar icons                         *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
static const OverlayTypeClass Concrete(
...
static const OverlayTypeClass Tiberium1(
...
static const OverlayTypeClass Tiberium2(
...
static const OverlayTypeClass Tiberium3(
...
static const OverlayTypeClass Tiberium4(
...
static const OverlayTypeClass Tiberium5(
...
static const OverlayTypeClass Tiberium6(
...
static const OverlayTypeClass Tiberium7(
...
static const OverlayTypeClass Tiberium8(
...
static const OverlayTypeClass Tiberium9(
...
static const OverlayTypeClass Tiberium10(
...
static const OverlayTypeClass Tiberium11(
...
static const OverlayTypeClass Tiberium12(
...
static const OverlayTypeClass Squish(
 ...
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 09/01/1994 JLB : Created. * 4/25/1996 ST : Modified to load
