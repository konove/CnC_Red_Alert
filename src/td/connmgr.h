...
/* $Header:   F:\projects\c&c0\vcs\code\connmgr.h_v   1.25   02 Jan 1996
 * 11:14:54   JOE_BOSTIC  $ */
/***************************************************************************
 ...
 *-------------------------------------------------------------------------*
 *                                                                         *
 * This is the Connection Manager base class.  This is an abstract base * class
 *that's just a shell for more functional derived classes.
 ...
 **
 * - Init:			initialization; should perform
 *hardware-dependent			* initialization, then Init each
 *connection; this function	* isn't defined in this class, since the
 *parameters will 	* be highly protocol-dependent)
 **
 * - Send_Message:sends a packet across the connection (this function * isn't
 *defined in this class, since the parameters will 	* be highly
 *protocol-dependent)
 **
 * - Get_Message:	gets a message from the connection (this function
 ** isn't defined in this class, since the parameters will 	* be highly
 *protocol-dependent)
 **
 *                                                                         *
...
#ifndef CNC_RED_ALERT_TD_CONNMGR_H_
#define CNC_RED_ALERT_TD_CONNMGR_H_
...
class ConnManClass {
 ...
 public:
  ...
  virtual void Configure_Debug(int index, int type_offset, int type_size,
                               const char** names, int maxnames) = 0;
...
#endif  // CNC_RED_ALERT_TD_CONNMGR_H_
