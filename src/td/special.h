...
/* $Header:   F:\projects\c&c\vcs\code\special.h_v   2.15   16 Oct 1995 16:47:36
 * JOE_BOSTIC  $ */
/***********************************************************************************************
...
class SpecialClass {
  ...
  */
  ...
  /*
  **	When this flag is true, the computer findpath algorithm reveals the
  *route being *	examined. This is used to trace findpath bugs.
  */
