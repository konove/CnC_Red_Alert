...
/* $Header:   F:\projects\c&c\vcs\code\power.cpv   2.18   16 Oct 1995 16:52:10
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *redraw logic to see if sidebar to redraw too. * Power_Height -- Given a value
 *figure where it falls on bar                                *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
