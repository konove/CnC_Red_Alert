...
/* $Header:   F:\projects\c&c\vcs\code\options.cpv   2.17   16 Oct 1995 16:51:28
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *the settings specified.  * OptionsClass::Get_Brightness -- Fetches the current
 *brightness setting.                   * OptionsClass::Get_Color -- Fetches the
 ...
 *constant.           * OptionsClass::One_Time -- This performs any one time
 *initialization for the options class.* OptionsClass::OptionsClass -- The
 ...
 *specified.              * OptionsClass::Set_Color -- Sets the color to the
 *value specified.                         * OptionsClass::Set_Contrast -- Sets
 *the contrast to the value specified.                   *
 ...
 *inializations for the    * options class that is needed. This may include
 ...
 *                                                                                             *
 *    This routine will set the constrast to the setting specified. This setting
...
void OptionsClass::Load_Settings() {
  ...
  */
  ...
  Set_Sound_Volume(WWGetPrivateProfileInt("Options", "Volume", 0x66, buffer),
                   false);
  Set_Score_Volume(
      WWGetPrivateProfileInt("Options", "ScoreVolume", 0x40, buffer));
  ...
  */
  ...
  /*
  **	Smarter self defense logic. Tanks will try to run over adjacent
  *infantry. Buildings *	will automatically return fire if they are fired
