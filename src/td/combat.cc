...
/* $Header:   F:\projects\c&c\vcs\code\combat.cpv   2.17   16 Oct 1995 16:48:32
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * Explosion_Damage -- Inflict an explosion damage affect. *
...
int Modify_Damage(int damage, WarheadType warhead, ArmorType armor,
  ...
  */
  ...
  /*
  **	If damage was indicated, then it should never drop below one damage
