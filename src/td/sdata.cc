...
/* $Header:   F:\projects\c&c\vcs\code\sdata.cpv   2.17   16 Oct 1995 16:52:10
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * SmudgeTypeClass::Draw_It -- Renders the smudge image at the
 *coordinate specified.         * SmudgeTypeClass::Create_One_Of -- Creates a
 *smudge object of this type.                   *
 *   SmudgeTypeClass::Create_And_Place -- Creates and places on map, a smudge
 *object.          * SmudgeTypeClass::Prep_For_Add -- Prepares the scenario
 *editor for adding a smudge object. * SmudgeTypeClass::Init -- Performs theater
 *specific initializations.                       * SmudgeTypeClass::Display --
 *Draws a generic version of this smudge type.                  *
 *   SmudgetypeClass::Occupy_List -- Determines occupation list for smudge
 *object.             * SmudgeTypeClass::From_Name -- Converts an ASCII name
 *into a smudge type.                  * SmudgeTypeClass::SmudgeTypeClass --
 *Constructor for smudge type objects.                  *
