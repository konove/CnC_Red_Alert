...
// Please insert the Covert Missions CD into the CD-ROM drive.
#define TXT_CD_DIALOG_3 718
...
#define TXT_UNABLE_TO_ALLOCATE_PRIMARY_VIDEO_BUFFER \
  734                                          // Error - Unable to allocate
