...
/* $Header:   F:\projects\c&c\vcs\code\theme.cpv   2.18   16 Oct 1995 16:51:10
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * ThemeClass::Scan -- Scans all scores for availability. *
 ...
 *theme.             * ThemeClass::Track_Length -- Caclulates the length of the
 *song (in seconds).               *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *song.                          *
 *                                                                                             *
 * INPUT:   theme -- The song to start playing. If -1 is pssed in, then just the
 *current song  * is faded. *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   none *
 ...
 *                                                                                             *
 * WARNINGS:   This cuts off any current song in a abrubt manner. Only use this
