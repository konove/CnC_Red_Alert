...
/* $Header:   F:\projects\c&c\vcs\code\type.h_v   2.20   16 Oct 1995 16:45:42
 * JOE_BOSTIC  $ */
/***********************************************************************************************
...
class TechnoTypeClass : public ObjectTypeClass {
  ...
  */
  ...
  /*
  **	Certain units and buildings fire two shots in quick succession. If this
  *is *	the case, then this flag is true.
  */
  bool IsTwoShooter : 1;
  ...
  */
  ...
  /*
  **	Is this object possible to be constructed?  Certain buildings and units
  *cannot *	be constructed using normal means. They are either initially
  *placed in the scenario *	or can only arrive by pre arranged reinforcement
  *scheduling. Civilian buildings and *	vehicles are typical examples of this
  *type of object. They would set this flag to *	false.
  */
  bool IsBuildable : 1;
  ...
  */
  ...
  /*
  **	Is this object typically used to transport reinforcements or other
  *cargo? *	Transport aircraft, helicopters, and hovercraft are typicall
  *examples of *	this.
  */
  bool IsTransporter : 1;
...
class UnitTypeClass : public TechnoTypeClass {
  ...
  */
  ...
  /*
  **	Does this unit's shape data consist of "chunky" facings?  This kind of
  *unit *	art has the unit in only 4 facings (N, W, S, and E) and in each
  *of those *	directions, the unit's turrets rotates 32 facings (counter
  *clockwise from north). *	This will result in 32 x 4 = 128 unit shapes in
  *the shape data file.
  */
  bool IsChunkyShape : 1;
  ...
  */
  ...
  /*
  **	Does this unit lay tracks when it travels?  Most tracked vehicles and
  *some wheeled *	vehicles have this ability.
  */
  bool IsTracked : 1;
...
class BulletTypeClass : public ObjectTypeClass {
  ...
  */
  ...
  /*
  **	If this projecile is one that balistically arcs from ground level, up
  ...
  */
  ...
  /*
  **	Some projectiles have a built in override for distance travelled before
  *it *	automatically explodes. This value, if non-zero, specifies this
  *distance.
  */
  int Range;

  //---------------------------------------------------------------------
  BulletTypeClass(BulletType type, const char* ininame, bool is_high,
...
class SmudgeTypeClass : public ObjectTypeClass {
  ...
  */
  ...
  [[nodiscard]] RTTIType What_Am_I() const override { return RTTI_SMUDGETYPE; }
