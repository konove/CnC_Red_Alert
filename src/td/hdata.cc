...
/* $Header:   F:\projects\c&c\vcs\code\hdata.cpv   2.17   16 Oct 1995 16:48:18
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * HouseTypeClass::From_Name -- Fetch house pointer from its name.
 ...
 *                                                                                             *
 * INPUT:   house    -- The ID number for this house type. * ini      -- The INI
 *name of this house.                                            * fullname --
 *The text number representing the complete name of the house.           * ext
 *-- The filename extension used when loading data files.                   *
 *          lemon    -- The percentage for objects of this ownership to be
 *lemon.              * remapc   -- The remap color number to use. * color    --
 *The radar color to use for this "house".                               *
 *          prefix   -- A unique prefix letter used when building custom
 *filenames.            *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
