...
/* $Header: g:/library/source/rcs/./lib.c 1.16 1994/05/20 15:34:33 joe_bostic
 * Exp $ */
/***************************************************************************
 ...
 *   Find_Argv -- Checks to see if string is in arguement * Mono_Mem_Dump --
 *Dumps memory to mono monitor with hex and char.      * Convert_HSV_To_RGB --
 *Converts HSV cordinates to RGB values           * Convert_RGB_To_HSV --
 *Converts RGB to RSV coordinates.                * Set_Search_Drives -- Sets up
 *the CDRom and HardDrive paths.           *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
 ...
 *             in long instead of unsigned int. * HISTORY: * 02/11/1992  SB :
 *Created.                                             *
 *=========================================================================*/
