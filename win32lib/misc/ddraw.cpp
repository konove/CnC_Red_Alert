...
BOOL SystemToVideoBlits =
    FALSE;  // Does hardware support system mem to video mem blits?
BOOL VideoToSystemBlits =
    FALSE;  // Does hardware support video mem to system mem blits?
BOOL SystemToSystemBlits =
    FALSE;  // Does hardware support system mem to system mem blits?
...
void Process_DD_Result(HRESULT result, int display_ok_msg) {
  switch (result) {
    case DD_OK:
      if (display_ok_msg) {
        MessageBox(MainWindow, "Direct Draw request went ok.", "Note",
                   MB_ICONEXCLAMATION | MB_OK);
      }
      break;
    case DDERR_ALREADYINITIALIZED:
      MessageBox(MainWindow, "This object is already initialized ", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_BLTFASTCANTCLIP:
      MessageBox(MainWindow,
                 "Return if a clipper object is attached to the source surface "
    ...
    case DDERR_CANTCREATEDC:
      MessageBox(MainWindow, "Windows can not create any more DCs", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_CANTLOCKSURFACE:
      MessageBox(MainWindow,
                 "Unable to lock surface because no driver exists which can "
                 "supply a pointer to the surface.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_CLIPPERISUSINGHWND:
      MessageBox(MainWindow,
                 "An attempt was made to set a cliplist for a clipper object "
                 "that is already monitoring an hwnd.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_COLORKEYNOTSET:
      MessageBox(MainWindow, "No src color key specified for this operation.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_DIRECTDRAWALREADYCREATED:
      MessageBox(MainWindow,
                 "A DirectDraw object representing this driver has already "
    ...
    case DDERR_EXCLUSIVEMODEALREADYSET:
      ...
      break;
    case DDERR_GENERIC:
      MessageBox(MainWindow, "Generic failure.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_HWNDSUBCLASSED:
      MessageBox(MainWindow,
                 "HWND used by DirectDraw CooperativeLevel has been "
                 "subclassed, this prevents DirectDraw from restoring state.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_INCOMPATIBLEPRIMARY:
      MessageBox(MainWindow,
                 "Unable to match primary surface creation request with "
    ...
    case DDERR_INVALIDCLIPLIST:
      MessageBox(MainWindow,
                 "DirectDraw does not support the provided cliplist.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_INVALIDDIRECTDRAWGUID:
      MessageBox(MainWindow,
                 "The GUID passed to DirectDrawCreate is not a valid "
                 "DirectDraw driver identifier.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_INVALIDMODE:
      MessageBox(MainWindow, "DirectDraw does not support the requested mode.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_INVALIDPIXELFORMAT:
      MessageBox(MainWindow, "The pixel format was invalid as specified.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_INVALIDPOSITION:
      MessageBox(MainWindow,
                 "Returned when the position of the overlay on the destination "
                 "is no longer legal for that destination.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_INVALIDRECT:
      MessageBox(MainWindow, "Rectangle provided was invalid.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_INVALIDSURFACETYPE:
      MessageBox(MainWindow,
                 ...
                 "surface was of the wrong type.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_LOCKEDSURFACES:
      MessageBox(MainWindow,
                 "Operation could not be carried out because one or more "
                 "surfaces are locked.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_NO3D:
      MessageBox(MainWindow, "There is no 3D present.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_NOANTITEARHW:
      MessageBox(
          ...
          "support for synchronizing blts to avoid tearing.	",
          "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
#endif
    case DDERR_NOBLTHW:
      MessageBox(MainWindow, "No blter hardware present.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
#if (0)
    ...
    case DDERR_NOCLIPLIST:
      MessageBox(MainWindow, "No cliplist available.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_NOCLIPPERATTACHED:
      MessageBox(MainWindow, "No clipper object attached to surface object.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_NOCOLORKEY:
      MessageBox(MainWindow, "Surface doesn't currently have a color key",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_NOCOOPERATIVELEVELSET:
      ...
      break;
    case DDERR_NODC:
      MessageBox(MainWindow, "No DC was ever created for this surface.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_NODDROPSHW:
      MessageBox(MainWindow, "No DirectDraw ROP hardware.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_NODIRECTDRAWHW:
      MessageBox(MainWindow,
                 "A hardware-only DirectDraw object creation was attempted but "
    ...
    case DDERR_NOEMULATION:
      MessageBox(MainWindow, "Software emulation not available.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_NOEXCLUSIVEMODE:
      ...
      break;
    case DDERR_NOFLIPHW:
      MessageBox(MainWindow, "Flipping visible surfaces is not supported.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_NOGDI:
      MessageBox(MainWindow, "There is no GDI present.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_NOHWND:
      MessageBox(MainWindow,
                 "Clipper notification requires an HWND or no HWND has "
                 "previously been set as the CooperativeLevel HWND.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_NOOVERLAYHW:
      MessageBox(MainWindow,
                 "Operation could not be carried out because there is no "
                 "overlay hardware present or available.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_NOPALETTEHW:
      MessageBox(MainWindow,
                 "No hardware support for 16 or 256 color palettes.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_NOT4BITCOLOR:
      MessageBox(MainWindow,
                 ...
                 "requested operation requires 4 bit color palette.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_NOT4BITCOLORINDEX:
      MessageBox(MainWindow,
                 "DirectDrawSurface is not in 4 bit color index palette and "
                 "the requested operation requires 4 bit color index palette.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_NOT8BITCOLOR:
      MessageBox(MainWindow,
                 "DirectDrawSurface is not in 8 bit color mode and the "
                 "requested operation requires 8 bit color.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_NOTFLIPPABLE:
      ...
      break;
    case DDERR_NOTFOUND:
      MessageBox(MainWindow, "Requested item was not found.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_NOVSYNCHW:
      MessageBox(MainWindow,
                 "Operation could not be carried out because there is no "
                 "hardware support for vertical blank synchronized operations.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_NOZBUFFERHW:
      MessageBox(MainWindow,
                 "Operation could not be carried out because there is no "
                 "hardware support for zbuffer blting.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_OUTOFCAPS:
      MessageBox(MainWindow,
                 "The hardware needed for the requested operation has already "
                 "been allocated.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_OVERLAYCANTCLIP:
      MessageBox(MainWindow, "The hardware does not support clipped overlays.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_PRIMARYSURFACEALREADYEXISTS:
      MessageBox(MainWindow,
                 "This process already has created a primary surface.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_REGIONTOOSMALL:
      MessageBox(MainWindow,
                 "Region passed to Clipper::GetClipList is too small.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_SURFACEALREADYDEPENDENT:
      MessageBox(MainWindow,
                 "This surface is already a dependency of the surface it is "
    ...
    case DDERR_SURFACELOST:
      MessageBox(MainWindow,
                 "Access to this surface is being refused because the surface "
                 "memory is gone. The DirectDrawSurface object representing "
                 "this surface should have Restore called on it.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_SURFACENOTATTACHED:
      MessageBox(MainWindow, "The requested surface is not attached.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_TOOBIGHEIGHT:
      MessageBox(MainWindow, "Height requested by DirectDraw is too large.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_TOOBIGWIDTH:
      MessageBox(MainWindow, "Width requested by DirectDraw is too large.",
                 "Note", MB_ICONEXCLAMATION | MB_OK);
      break;
    case DDERR_UNSUPPORTED:
      MessageBox(MainWindow, "Action not supported.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    case DDERR_VERTICALBLANKINPROGRESS:
      MessageBox(MainWindow, "Vertical blank is in progress.", "Note",
                 MB_ICONEXCLAMATION | MB_OK);
      break;
    ...
    default:
      char string[256];
      sprintf(string, "Unrecognised Direct Draw result code: %d",
              result & 0xffff);
...
BOOL Set_Video_Mode(HWND hwnd, int w, int h, int bits_per_pixel) {
  ...
  if (DirectDrawObject == NULL) {
    ...
    // DirectDrawCreate.","Note", MB_ICONEXCLAMATION|MB_OK);
    ...
    if (result == DD_OK) {
      if (w == 320) {
        result = DirectDrawObject->SetCooperativeLevel(
            hwnd, DDSCL_EXCLUSIVE | DDSCL_FULLSCREEN | DDSCL_ALLOWMODEX);
      } else {
        // MessageBox(MainWindow, "In Set_Video_Mode. About to call
        // SetCooperativeLevel.","Note", MB_ICONEXCLAMATION|MB_OK);
        result = DirectDrawObject->SetCooperativeLevel(
...
unsigned int Get_Free_Video_Memory(void) {
  ...
  if (DirectDrawObject) {
    ...
    // MessageBox(MainWindow, "In Get_Free_Video_Memory. About to call
    // GetCaps","Note", MB_ICONEXCLAMATION|MB_OK);
    if (DD_OK == DirectDrawObject->GetCaps(&video_capabilities, NULL)) {
      char string[256];
      sprintf(string, "In Get_Free_Video_Memory. About to return %d bytes",
  ...
  // MessageBox(MainWindow, "In Get_Free_Video_Memory. About to return
  // failure","Note", MB_ICONEXCLAMATION|MB_OK);
  return (0);
}
...
void Set_DD_Palette(void *palette) {
  ...
  */
  ...
  if (DirectDrawObject && PaletteSurface) {
    ...
    if (!FirstPaletteSet) {
      // MessageBox(MainWindow, "In Set_DD_Palette. About to call
      // SetPalette","Note", MB_ICONEXCLAMATION|MB_OK);
      PaletteSurface->SetPalette(PalettePtr);
      FirstPaletteSet = TRUE;
    }

    // MessageBox(MainWindow, "In Set_DD_Palette. About to call
    // SetEntries","Note", MB_ICONEXCLAMATION|MB_OK);
    PalettePtr->SetEntries(0, 0, 256, &PaletteEntries[0]);
  }
  // MessageBox(MainWindow, "Leaving Set_DD_Palette","Note",
  // MB_ICONEXCLAMATION|MB_OK);
}
 ...
 * WARNINGS: None *
 *                                                                                             *
 * HISTORY: * 11/3/95 3:24PM ST : Created *
 *=============================================================================================*/
 ...
 * WARNINGS: None *
 *                                                                                             *
 * HISTORY: * 11/3/95 3:25PM ST : Created *
 *=============================================================================================*/
...
BOOL SurfaceMonitorClass::Got_Surface_Already(
 ...
 *                                                                                             *
 *  The InFocus flag is used to keep track of whether our application is
 *currently in focus.   * We dont want to be restoring video surfaces when we
 *are supposed to be running in the      * background. *
 *                                                                                             *
 * INPUT:    bool in focus *
 *                                                                                             *
 * OUTPUT:   Nothing *
 ...
 * WARNINGS: None *
 *                                                                                             *
 * HISTORY: * 11/6/95 12:21PM ST : Created *
 *=============================================================================================*/
