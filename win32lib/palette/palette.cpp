 ...
 **
 *                                                                         *
 * This will allow the palette to fade from current palette into the * palette
 *that was passed in.  This can be used to fade in and fade out.	*
 *                                                                         *
 * INPUT:
 ** char  *palette1 - this is the palette to fade to. * unsigned int delay
 *-	fade with this timer count down
 ...
 ** step			- max step amount, determined by
 *Determine_Bump_Rate		*
 *                                                                         *
 * OUTPUT:                                                                 *
