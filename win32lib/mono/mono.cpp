...
/* $Header:   F:\projects\c&c\vcs\code\monoc.cpv   2.12   06 Sep 1995 16:37:54
 * JOE_BOSTIC  $ */
/***********************************************************************************************
...
void MonoClass::Set_Cursor(int x, int y) {
  ...
  if (Page == 0) {
    output(CONTROL_PORT, (short)0x0E | (short)(pos & 0xFF00));
    output(CONTROL_PORT, (short)0x0F | (short)(pos << 8));
  }
#endif
}
