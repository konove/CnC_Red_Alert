...
**
** Use Register_Icon_Set to identify a set of icons as cachable. Once
*registered, the icons
** will be cached automatically when drawn.
** Use Invalidate_Cached_Icons at the end of icon drawing to release the video
*memory used by the
** caching system.
** Restore_Cached_Icons may be used to reload the icons into video memory after
*a focus loss.
**
*/
