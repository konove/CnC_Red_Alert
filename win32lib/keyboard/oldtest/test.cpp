 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * WndProc			-- Callback procedure for main window *
 *  WinMain 		-- Program entry point * Init_Keyboard_Remap_Table --
 *initializes the keyboard remap table     * WWKeyboardClass::WWKeyBoardClass --
 *Construction for Westwood Keyboard*
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
char* VK_Name[] = {
    ...
    "VK_NONE_0F", "VK_SHIFT",    "VK_CONTROL", "VK_MENU",      "VK_PAUSE",
    "VK_CAPITAL", "VK_NONE_15",  "VK_NONE_16", "VK_NONE_17",   "VK_NONE_18",
    "VK_NONE_19", "VK_NONE_1A",  "VK_ESCAPE",  "VK_NONE_1C",   "VK_NONE_1D",
    "VK_NONE_1E", "VK_NONE_1F",  "VK_SPACE",   "VK_PRIOR",     "VK_NEXT",
    "VK_END",     "VK_HOME",     "VK_LEFT",    "VK_UP",        "VK_RIGHT",
    "VK_DOWN",    "VK_SELECT",   "VK_PRINT",   "VK_EXECUTE",   "VK_SNAPSHOT",
    "VK_INSERT",  "VK_DELETE",   "VK_HELP",    "VK_0",         "VK_1",
    "VK_2",       "VK_3",        "VK_4",       "VK_5",         "VK_6",
    "VK_7",       "VK_8",        "VK_9",       "VK_0",         "VK_NONE_3B",
    "VK_NONE_3C", "VK_NONE_3D",  "VK_NONE_3E", "VK_NONE_3F",   "VK_NONE_40",
    "VK_A",       "VK_B",        "VK_C",       "VK_D",         "VK_E",
    "VK_F",       "VK_G",        "VK_H",       "VK_I",         "VK_J",
    "VK_K",       "VK_L",        "VK_M",       "VK_N",         "VK_O",
    "VK_P",       "VK_Q",        "VK_R",       "VK_S",         "VK_T",
    "VK_U",       "VK_V",        "VK_W",       "VK_X",         "VK_Y",
    "VK_Z",       "VK_NONE_5B",  "VK_NONE_5C", "VK_NONE_5D",   "VK_NONE_5E",
    "VK_NONE_5F", "VK_NUMPAD0",  "VK_NUMPAD1", "VK_NUMPAD2",   "VK_NUMPAD3",
    "VK_NUMPAD4", "VK_NUMPAD5",  "VK_NUMPAD6", "VK_NUMPAD7",   "VK_NUMPAD8",
    "VK_NUMPAD9", "VK_MULTIPLY", "VK_ADD",     "VK_SEPARATOR", "VK_SUBTRACT",
    "VK_DECIMAL", "VK_DIVIDE",   "VK_F1",      "VK_F2",        "VK_F3",
    "VK_F4",      "VK_F5",       "VK_F6",      "VK_F7",        "VK_F8",
    "VK_F9",      "VK_F10",      "VK_F11",     "VK_F12",       "VK_F13",
    "VK_F14",     "VK_F15",      "VK_F16",     "VK_F17",       "VK_F18",
    "VK_F19",     "VK_F20",      "VK_F21",     "VK_F22",       "VK_F23",
    "VK_F24",     "VK_NONE_88",  "VK_NONE_89", "VK_NONE_8A",   "VK_NONE_8B",
    "VK_NONE_8C", "VK_NONE_8D",  "VK_NONE_8E", "VK_NONE_8F",   "VK_NUMLOCK",
    "VK_SCROLL",  "VK_NONE_92",  "VK_NONE_93", "VK_NONE_94",   "VK_NONE_95",
    "VK_NONE_96", "VK_NONE_97",  "VK_NONE_98", "VK_NONE_99",   "VK_NONE_9A",
    "VK_NONE_9B", "VK_NONE_9C",  "VK_NONE_9D", "VK_NONE_9E",   "VK_NONE_9F",
    "VK_NONE_A0", "VK_NONE_A1",  "VK_NONE_A2", "VK_NONE_A3",   "VK_NONE_A4",
    "VK_NONE_A5", "VK_NONE_A6",  "VK_NONE_A7", "VK_NONE_A8",   "VK_NONE_A9",
    "VK_NONE_AA", "VK_NONE_AB",  "VK_NONE_AC", "VK_NONE_AD",   "VK_NONE_AE",
    "VK_NONE_AF", "VK_NONE_B0",  "VK_NONE_B1", "VK_NONE_B2",   "VK_NONE_B3",
    "VK_NONE_B4", "VK_NONE_B5",  "VK_NONE_B6", "VK_NONE_B7",   "VK_NONE_B8",
    "VK_NONE_B9", "VK_NONE_BA",  "VK_NONE_BB", "VK_NONE_BC",   "VK_NONE_BD",
    "VK_NONE_BE", "VK_NONE_BF",  "VK_NONE_C0", "VK_NONE_C1",   "VK_NONE_C2",
    "VK_NONE_C3", "VK_NONE_C4",  "VK_NONE_C5", "VK_NONE_C6",   "VK_NONE_C7",
    "VK_NONE_C8", "VK_NONE_C9",  "VK_NONE_CA", "VK_NONE_CB",   "VK_NONE_CC",
    "VK_NONE_CD", "VK_NONE_CE",  "VK_NONE_CF", "VK_NONE_D0",   "VK_NONE_D1",
    "VK_NONE_D2", "VK_NONE_D3",  "VK_NONE_D4", "VK_NONE_D5",   "VK_NONE_D6",
    "VK_NONE_D7", "VK_NONE_D8",  "VK_NONE_D9", "VK_NONE_DA",   "VK_NONE_DB",
    "VK_NONE_DC", "VK_NONE_DD",  "VK_NONE_DE", "VK_NONE_DF",   "VK_NONE_E0",
    "VK_NONE_E1", "VK_NONE_E2",  "VK_NONE_E3", "VK_NONE_E4",   "VK_NONE_E5",
    "VK_NONE_E6", "VK_NONE_E7",  "VK_NONE_E8", "VK_NONE_E9",   "VK_NONE_EA",
    "VK_NONE_EB", "VK_NONE_EC",  "VK_NONE_ED", "VK_NONE_EE",   "VK_NONE_EF",
    "VK_NONE_F0", "VK_NONE_F1",  "VK_NONE_F2", "VK_NONE_F3",   "VK_NONE_F4",
    "VK_NONE_F5", "VK_NONE_F6",  "VK_NONE_F7", "VK_NONE_F8",   "VK_NONE_F9",
    "VK_NONE_FA", "VK_NONE_FB",  "VK_NONE_FC", "VK_NONE_FD",   "VK_NONE_FE",
    "VK_NONE_FF",
};
 ...
 * WARNINGS: None *
 *                                                                                             *
 * HISTORY: * 9/27/95 1:39PM ST : Pilfered *
 *=============================================================================================*/
    ...
    if (Kbd.Check()) {
      ...
      if (key & WWKEY_VK_BIT) {
        ...
        if (!Kbd.Is_Mouse_Key(key)) {
          sprintf(buffer,
                  "Key (VK) = %d (%s)  shift = %d  control = %d  menu = %d  "
                  "rls = %d  dbl = %d",
                  key, VK_Name[key], shift, ctrl, alt, rls, dbl);
          if (key == 27) {
            PostMessage(MainWindow, WM_DESTROY, 0, 0);
          }
        } else {
          sprintf(buffer,
                  "Mouse = %d @ (%d,%d) shift = %d  control = %d  menu = %d",
                  key, Kbd.MouseQX, Kbd.MouseQY, shift, ctrl, alt);
        }
      } else {
        Kbd.Split(key, shift, ctrl, alt, rls, dbl);
        sprintf(buffer,
                "Key (ACSII) = %d (%c)  shift = %d  control = %d  menu = %d  "
                "rls = %d  dbl = %d",
                key, key, shift, ctrl, alt, rls, dbl);
      }
      hdc = GetDC(MainWindow);
      TextOut(hdc, cxChar, cyChar * (line + 1), buffer, lstrlen(buffer));
      sprintf(buffer, "Mouses current status:  x = %3d,  y = %3d",
              Kbd.Get_Mouse_X(), Kbd.Get_Mouse_Y());
 ...
 * WARNINGS: None *
 *                                                                                             *
 * HISTORY: * 9/27/95 1:28PM ST : Created *
 *=============================================================================================*/
...
int PASCAL WinMain(HANDLE hInstance, HANDLE hPrevInstance,
  ...
  //
  hwnd = MainWindow =
      CreateWindowEx(WS_EX_TOPMOST, NAME, TITLE, WS_POPUP | WS_MAXIMIZE, 0, 0,
                     MODE_WIDTH, MODE_HEIGHT, NULL, NULL, hInstance, NULL);
...
//	Set_Video_Mode( MainWindow , MODE_WIDTH , MODE_HEIGHT , 8 );
  ...
  ThreadHandle = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)Message_Loop,
                              NULL, 0, &threadid);
  if (!ThreadHandle) {
