 ...
 ** WORD x								- x
 *offset into buffer			* WORD y
 *- y offset into buffer			* WORD w
 *- view port width in pixels   * WORD h
 ...
 *attach to  * WORD x                     - x position to attach to
 ** WORD y 							- y position to
 *attach to			* WORD w
 *- width of the view port			* WORD h
 ...
 **
 *                                                                  			*
 * HISTORY: * 09/14/1994 SKB : Created. *
 *=========================================================================*/
 ...
 **
 *                                                                         *
 * INPUT:		WORD w			- width of buffer in pixels
 *(default = 320)  * WORD h			- height of buffer in pixels
 *(default = 200) *
 *                                                                         *
 * OUTPUT:     none                                                        *
 *                                                                         *
 ...
 *=========================================================================*/
VideoBufferClass::VideoBufferClass(unsigned short selector, long offset, int w,
                                   int h) {
