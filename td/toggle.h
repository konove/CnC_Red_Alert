...
/* $Header:   F:\projects\c&c\vcs\code\toggle.h_v   2.16   16 Oct 1995 16:47:34
 * JOE_BOSTIC  $ */
/***********************************************************************************************
...
*is, once the mouse *	button is clicked over them, they capture the focus
*until the mouse button is released. *	They have a different imagery for the
*pressed and released states. They only recognize *	a valid selection when
*the mouse button is release while over the button.
*/
class ToggleClass : public ControlClass {
  ...
  *to *	true. Sometimes a button needs to display its on/off state. In the
  *render routine, *	examine the IsOn flag and display accordingly. If this
