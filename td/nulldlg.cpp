...
// #endif
#if (0)
  TextButtonClass inittypebutton(
      BUTTON_INITTYPE, init_text,
      TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW, d_inittype_x,
      d_inittype_y, d_inittype_w, d_inittype_h);
#endif  //(0)
      ...
      */
      if (display >= REDRAW_BACKGROUND) {
        ...
        Fancy_Text_Print(TXT_CWAIT_STRING, d_cwaitstr_x,
                         ...
                         TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW);
#if (0)
        Fancy_Text_Print("Modem Init", d_inittype_x,
                         d_inittype_y - d_txt6_h - d_margin, CC_GREEN, TBLACK,
                         TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW);
#endif  //(0)
      }
      ...
      case (BUTTON_OK | KN_BUTTON):
        if (!ready_to_go) {
          ...
          if (gameoptions) {
            ...
            while ((NullModem.Num_Send() && ((TickCount.Time() - starttime) <
              ...
              if (i == 3) {
                ...
                while (sent_so_far < message_length) {
                  ...
                  */
                  ...
                  while ((COMPAT_MESSAGE_LENGTH - 5) - actual_message_size <
                             10 &&
                         the_string[actual_message_size] != ' ') {
                    --actual_message_size;
                  }
    ...
    */
    if (display) {
      ...
      */
      ...
      Fancy_Text_Print(text_buffer, x + 20 * factor, y + 25 * factor, CC_GREEN,
