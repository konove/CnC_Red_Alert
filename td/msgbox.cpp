...
/* $Header:   F:\projects\c&c\vcs\code\msgbox.cpv   2.18   16 Oct 1995 16:50:48
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * CCMessageBox::Process -- Handles all the options graphic
 *interface.                         * CCMessageBox::Process -- Displays message
 *box.                                              *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *                                                                                             *
 * This function displays a dialog box with a one-line message, and * up to two
 *buttons. The 2nd button is optional. The buttons default * to "OK" and
 *nothing, respectively. The hotkeys for the buttons are * RETURN and ESCAPE. *
 *                                                                                             *
 * INPUT: * msg         message to display * b1txt         text for 1st button *
 *      b2txt         text for 2nd button; NULL = no 2nd button *
 *                                                                                             *
 * OUTPUT: * # of button selected (0 = 1st) *
 *                                                                                             *
 * WARNINGS: * 'msg' text must be <= 38 chars * 'b1txt' and 'b2txt' must each be
 *<= 18 chars                                           *
 *                                                                                             *
 * HISTORY: * 11/08/1994 BR : Created. * 05/18/1995 JLB : Uses new font and
 *dialog style.                                          * 08/24/1995 JLB :
 ...
 *                                                                                             *
 *    This routine will display a message box and wait for player input. It
 *varies from the    * other message box functions only in the type of
 *parameters it takes.                     *
 *                                                                                             *
 ...
 *                                                                                             *
 * OUTPUT:  Returns with the button selected. "true" if "OK" was pressed, and
