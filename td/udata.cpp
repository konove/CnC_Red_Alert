...
/* $Header:   F:\projects\c&c\vcs\code\udata.cpv   2.17   16 Oct 1995 16:50:42
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *unit.                      * UnitTypeClass::UnitTypeClass -- Constructor for
 *unit types.                               * UnitTypeClass::Who_Can_Build_Me --
 *Determines which factory can build this unit type.     *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
static UnitTypeClass const UnitHarvester(
    ...
    600,     // STRENGTH:	Strength (in damage points).
             //	300,
             //// STRENGTH:	Strength (in damage points).
 ...
 * UnitTypeClass::Occupy_List -- Returns with unit occupation list. *
 *                                                                                             *
 *    This routine returns with an occupation list for the unit type. * The unit
 *occupation list is used for placing units. *
 *                                                                                             *
 ...
 * WARNINGS: None *
 *                                                                                             *
 * HISTORY: * 4/26/96 4:07PM ST : Created *
 *=============================================================================================*/
...
/***********************************************************************************************
 * UnitTypeClass::Who_Can_Build_Me -- Determines which factory can build this
 *unit type.       *
 *                                                                                             *
 *    Use this routine to examine the buildings on the map in order to determine
 *which one     * can build the unit type. *
 *                                                                                             *
 * INPUT:   intheory -- If this parameter is true, then no examination of
 *whether the factory  * is currently busy is performed. It just checks to see
 *if the unit      * could be produced "in theory". *
 *                                                                                             *
 ...
 *                                                                                             *
 * OUTPUT:  Returns with pointer to the factory that can produce the unit. If no
 *suitable      * factory could be found then NULL is returned. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *indicated by       * the unit type number speicified. *
 *                                                                                             *
 ...
 ** step. A step is defined as the number of hit points returned from the
 *Repair_Step()      * function. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
