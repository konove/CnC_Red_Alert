...
/* $Header:   F:\projects\c&c\vcs\code\cell.h_v   2.20   16 Oct 1995 16:45:36
 * JOE_BOSTIC  $ */
/***********************************************************************************************
...
class CellClass {
  ...
  *changes in the cell *	that might change the radar map imagery, then
  ...
  *the shadow), *	this this flag will be true. Mapped cells always have
