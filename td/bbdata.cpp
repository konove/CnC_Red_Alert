...
/* $Header:   F:\projects\c&c\vcs\code\bbdata.cpv   2.17   16 Oct 1995 16:49:46
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * BulletTypeClass::BulletTypeClass -- Constructor for bullet type
 *objects.                  * BulletTypeClass::Load_Shapes -- Load shape data
 *for bullet types.                         * BulletTypeClass::One_Time --
 *Performs the one time processing for bullets.                *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
