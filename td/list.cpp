...
/* $Header:   F:\projects\c&c\vcs\code\list.cpv   2.17   16 Oct 1995 16:51:36
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 * HISTORY: * 01/16/1995 JLB : Created. *
 *=============================================================================================*/
char const *ListClass::Current_Item(void) { return (List[SelectedIndex]); }
 ...
 *                                                                                             *
 * Adds the list box to the chain, immemdiately after the given object.  The
 *order will be:    *
 * - Listbox *
 * - Up arrow (if active) *
