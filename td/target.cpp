...
/* $Header:   F:\projects\c&c\vcs\code\target.cpv   2.17   16 Oct 1995 16:51:06
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *   As_Object -- Converts a target value into an object pointer. * As_Team --
 ...
 *   As_Trigger -- Converts specified target into a trigger pointer. * As_Unit
 *-- Converts a target value into a unit pointer. * Target_Legal -- Determines
 *if the specified target is legal.                              *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
