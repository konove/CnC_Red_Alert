...
/* $Header:   F:\projects\c&c\vcs\code\msglist.cpv   1.4   16 Oct 1995 16:48:20
 * JOE_BOSTIC  $ */
/***************************************************************************
 *                                                                         *
 ...
 *   05/21/1995 BRR : Created.                                             *
 *=========================================================================*/
MessageListClass::~MessageListClass() { Init(0, 0, 0, 0, 0); }
...
TextLabelClass* MessageListClass::Add_Message(char* txt, int color,
  ...
  ** can add this message to the tail of an existing message (crc's must also
  *match)
  */
