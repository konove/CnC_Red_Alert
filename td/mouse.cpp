...
/* $Header:   F:\projects\c&c\vcs\code\mouse.cpv   2.18   16 Oct 1995 16:49:56
 * JOE_BOSTIC  $ */
/***********************************************************************************************
 ...
 *mouse                         * MouseClass::Override_Mouse_Shape -- Alters the
 *shape of the mouse.                        * MouseClass::Init_Clear -- Sets
 *the mouse system to a known state                          *
 ...
 *system.         * MouseClass::Set_Default_Mouse -- Sets the mouse to match the
 *shape specified.             * MouseClass::Revert_Mouse_Shape -- Reverts the
 *mouse shape to the non overridden shape.    *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
