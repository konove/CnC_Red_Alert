 ...
 *					is installed in either hardware or
 *software.						*
 *                                                                         *
 * HISTORY:                                                                *
...
PRIVATE void Init_Bank_Table(void) {
  ...
  for (lp = 0; lp < num_banks; lp++) BankTable[lp] = lp * bankval;
...
int Set_Video_Mode(int mode) {
   ...
   */
  /*======================================================================*/
  if ((oldmode >= VESA_MIN) && (oldmode <= VESA_MAX)) Remove_Vesa();
 ...
 * OUTPUT:     none                                                        *
 *                                                                         *
 * WARNINGS:   Must call Install_Vesa before attempting to get the vesa * info.
 **
 *                                                                         *
 * HISTORY:                                                                *
...
void Vesa_Info(void) {
  cout << "Attributes:                    " << (long)ModeInfo.Attributes << "\n"
       ...
       << "Win A Segment:                 " << hex
       << (unsigned short)ModeInfo.WinA_Segment << "\n"
       << "Win B Segment:                 "
 ...
 *                                                                         *
 * INPUT:		int window	- 0 for window A, 1 for window B * int
 *grain   - the granularity point for window *
 *                                                                         *
 * OUTPUT:		none *
 *                                                                         *
 * HISTORY:                                                                *
 ...
 *=========================================================================*/
void Set_Original_Video_Mode(int mode) { _OriginalVideoMode = mode; }
