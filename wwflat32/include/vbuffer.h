 ...
 * *		ram, like a graphic card.  The SeenPage is a good example of a
 Video	* *		Buffer.
 *
...
#ifdef __cplusplus
extern "C" {
extern UWORD Get_MCGA_Selector();
}
#endif
 ...
 */
/*		to a VideoBuffer.  A viewport is effectively a	rectangular
 * subset   */
/*    of the full buffer which is used for clipping and the like.
 */
/*																									*/
/*			int 		Selector	-		is the
 * selector to view port buffer			*/
...
class VideoViewPortClass {
 public:
  ...
  int Get_XPos();
  int Get_YPos();
  VideoBufferClass* Get_Video_Buffer();
...
/*																									*/
/*			int	  	Selector	-		is now
 * the selector to graphic buffer		*/
/*			char	  	*Buffer	-		is now the
 * offset to graphic buffer			*/
/*			int	  	Width		-		is now
 * the width of graphic buffer			*/
/*			int	  	Height	-		is now the
 * height of graphic buffer			*/
/*			int	  	XAdd		-		is now
 * the xadd of graphic buffer			*/
/*			int		XPos;		- 		will be
 ...
 *=========================================================================*/
inline long VideoViewPortClass::Get_Offset() { return (Offset); }
 ...
 *   06/07/1994 PWG : Created.                                             *
 *=========================================================================*/
inline int VideoViewPortClass::Get_Height() { return (Height); }
 ...
 *   06/07/1994 PWG : Created.                                             *
 *=========================================================================*/
inline int VideoViewPortClass::Get_Width() { return (Width); }
 ...
 *   06/07/1994 PWG : Created.                                             *
 *=========================================================================*/
inline int VideoViewPortClass::Get_XAdd() { return (XAdd); }
/***************************************************************************
 * VVPC::GET_XPOS -- Get the x pos of the VP on the Video                  *
 *                                                                         *
 * INPUT:		none *
 ...
 *=========================================================================*/
inline int VideoViewPortClass::Get_XPos() { return (XPos); }
...
;*   08/22/1994 SKB : Created.                                             *
 *=========================================================================*/
inline int VideoViewPortClass::Get_YPos() { return (YPos); }
 ...
 *   08/22/1994 SKB : Created.                                             *
 *=========================================================================*/
inline VideoBufferClass* VideoViewPortClass::Get_Video_Buffer() {
  return (VideoBuff);
}
...
inline BOOL VideoViewPortClass::Blit(GraphicViewPortClass& dest, int x_pixel,
                                     ...
                                     BOOL trans) {
  return (VVPC_Blit_to_GVPC_Func(this, &dest, x_pixel, y_pixel, dx_pixel,
...
inline BOOL VideoViewPortClass::Blit(VideoViewPortClass& dest, int x_pixel,
                                     ...
                                     int pixel_width, int pixel_height,
                                     BOOL trans) {
  return (VVPC_Blit_to_VVPC_Func(this, &dest, x_pixel, y_pixel, dx_pixel,
                                 dy_pixel, pixel_width, pixel_height, trans));
}
 ...
 * HISTORY:                                                                *
 *=========================================================================*/
inline unsigned long VideoViewPortClass::Print(int num, int x, int y, int fcol,
                                               int bcol) {
  BYTE str[17];
 ...
 * HISTORY:                                                                *
 *=========================================================================*/
inline unsigned long VideoViewPortClass::Print(short num, int x, int y,
                                               int fcol, int bcol) {
  BYTE str[17];
 ...
 *=========================================================================*/
inline unsigned long VideoViewPortClass::Print(long num, int x, int y, int fcol,
                                               int bcol) {
  BYTE str[33];
...
inline BOOL GraphicViewPortClass::Blit(VideoViewPortClass& dest, int x_pixel,
                                       ...
                                       int pixel_width, int pixel_height,
                                       BOOL trans) {
  return (GVPC_Blit_to_VVPC_Func(this, &dest, x_pixel, y_pixel, dx_pixel,
                                 dy_pixel, pixel_width, pixel_height, trans));
}
