...
class GraphicBufferClass : public GraphicViewPortClass, public BufferClass {
 public:
  GraphicBufferClass(long size = 64500, int w = DEFAULT_SCREEN_WIDTH,
                     int h = DEFAULT_SCREEN_HEIGHT, VOID *buffer = 0);
  GraphicBufferClass(int w, int h, void *buffer = 0);
  ~GraphicBufferClass();

  void Scale_Rotate(BitmapClass &bmp, const TPoint2D &pt, long scale = 0x0100,
...
inline BOOL GraphicViewPortClass::Blit(GraphicViewPortClass &dest, int x_pixel,
                                       ...
                                       BOOL trans) {
  return (Linear_Blit_To_Linear(this, &dest, x_pixel, y_pixel, dx_pixel,
...
inline void GraphicViewPortClass::Draw_Stamp(void const *icondata, int icon,
                                             ...
                                             void const *remap,
                                             int clip_window) {
  MCGA_Draw_Stamp_Clip(this, icondata, icon, x_pixel, y_pixel, remap,
