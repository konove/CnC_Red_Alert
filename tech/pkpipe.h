...
*generating a *	symetric key that is then encrypted using the public key system.
*This symetric key is then *	used to encrypt the remaining data.
*/
class PKPipe : public Pipe {
  ...
  **	either encryption or decryption -- it makes no difference. However,
  ...
  *large as *	the largest possible key size or the largest blowfish key
