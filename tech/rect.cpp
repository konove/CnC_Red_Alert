 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * Rect::Rect -- Constructs a rectangle object. * Rect::Is_Valid --
 ...
 *                                                                                             *
 *    This will construct a rectangle object according to the parameters
 *specified.            *
 *                                                                                             *
 * INPUT:   x,y   -- The X and Y values of the upper left corner of the
 *rectangle.             *
 *                                                                                             *
 ...
 *                                                                                             *
 *    An invalid rectangle has values that do not make any sense. This is a
 *useful state since * this can be used to determine if a rectangle has been
 *initialized correctly or for       * detecting an error return condition for
 *rectangle manipulation routines.                 *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  bool; Does this rectangle appear valid? *
 *                                                                                             *
 * WARNINGS:   An invalid rectangle is one that has a width or height of less
 *than one.        *
 *                                                                                             *
 * HISTORY: * 07/22/1996 JLB : Created. *
 *=============================================================================================*/
 ...
 * Rect::Intersect -- Find the intersection between two rectangles. *
 *                                                                                             *
 *    This routine will take the specified rectangle and use it like a "cookie
 *cutter" on this * rectangle. The intersection of these two rectangles is
 *returned. An optional X and       * Y parameter is supplied so that an
 *absolute coordinate can be maintained to the new      * rectangle. *
 *                                                                                             *
 * INPUT:   rectangle   -- Reference to the rectangle to use as a cookie cutter.
 **
 *                                                                                             *
 *          x,y         -- Optional pointer to a coordinate that will be
 *adjusted to stay      * in an absolute position in coordinates even though it
 *is a          * relative offset. *
 *                                                                                             *
 * OUTPUT:  Returns with the rectangle that is the intersection of the one
 *specified and       * this rectangle. *
 *                                                                                             *
 * WARNINGS:   The rectangle returned may be invalid. This can occur if there is
 *no legal      * intersection between the rectangles. *
 *                                                                                             *
 * HISTORY: * 07/22/1996 JLB : Created. *
 *=============================================================================================*/
