 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * LayerClass::Sort -- Perform an incremental sort pass on the
 *layer's objects.              * LayerClass::Sorted_Add -- Adds object in
 *sorted order to layer.                           * LayerClass::Submit -- Adds
 *an object to a layer list.                                     *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
