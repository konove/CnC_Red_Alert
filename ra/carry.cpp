 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * CarryoverClass::CarryoverClass -- Constructor for carry over
 *objects.                     * CarryoverClass::Create -- Creates a carried
 *over object.                                  *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *                                                                                             *
 *    This is the constructor for a carry over object. Such an object is used to
 *record the    * object that will be "carried over" into a new scenario at some
 *future time.              *
 *                                                                                             *
 ...
 *                                                                                             *
 *    Use this routine to convert a carried over object into an actual object
 ...
 *                                                                                             *
 * WARNINGS:   This routine might not place the object if the old map location
 *was invalid     * or there are other barriers to the object's creation and
 *placement.             *
 *                                                                                             *
 * HISTORY: * 05/10/1996 JLB : Created. *
 *=============================================================================================*/
