 ...
 **
 *                                                                         *
 * Private & Global messages are sent via the same mechanism.  The only * way to
 *tell the difference between them is that the Global Channel		*
 * packets have the 'kGlobalChannelFlag' bit set in the 1st byte (the * "Type"
 *field for EventClass's, and the NetCommand field for Global		*
 * packets).
 **
 *                                                                         *
 * INPUT:                                                                  *
