 ...
 *type.              *
 *                                                                                             *
 *    This is the default constructor for the mission class object. It sets the
 *mission        * handler into a default -- do nothing -- state. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  none *
 ...
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 01/23/1995 JLB : Created. * 03/01/1996 JLB : Uses initializer
 *lists.                                                  *
 *=============================================================================================*/
 ...
 *                                                                                             *
 *    These are the stub routines that handle the mission logic. They do nothing
 *at this       * level. Derived classes will override these routine as
 *necessary.                         *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  Returns with the number of game frames to delay before calling this
 *mission        * handler again. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    Use this routine to set the current mission for this object. This routine
 *will blast     * over the current mission, bypassing the queue method. Call it
 *when the mission needs     * to be changed immediately. *
 *                                                                                             *
 ...
 *under.          *
 *                                                                                             *
 *    Use this routine to fetch the mission that this object is CURRENTLY acting
 *under. The    * mission queue may be filled with a imminent mission change,
 *but this routine does not    * consider that. It only returns the CURRENT
 *mission.                                      *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine will process the order script for as much time as * possible
 *or until a script delay is detected. This routine should * be called for every
 *unit once per game loop (if possible).                               *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  none *
...
void MissionClass::AI() {
  ...
  /*
  **	If this is the kind of object that is "paralyzed with fear" while it is
  *above *	ground level (such as when be paradropped), it will perform no
 ...
 * MissionClass::Commence -- Start script with new order. *
 *                                                                                             *
 *    This routine will start script processing according to any queued * order
 *it may have. If there is no queued order, then this routine * does nothing.
 *Call this routine whenever the unit is in a good                           *
 ...
 * MissionClass::Assign_Mission -- Give an order to a unit. *
 *                                                                                             *
 *    This routine will assign the specified mission to the mission queue for
 *this object.     * The actual mission logic will then be performed at the
 *first available and legal         * opportunity. *
 *                                                                                             *
 ...
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 06/04/1991 JLB : Created. * 04/15/1994 JLB : Converted to member
 *function.                                            *
 *=============================================================================================*/
 ...
 *    order number it represents. Typically, this is used when processing * a
 *scenario INI file. *
 *                                                                                             *
 ...
 **
 *                                                                                             *
 *    Use this routine to convert a mission number into the ASCII string that
 *represents       * it. Typical use of this is when generating an INI file. *
 *                                                                                             *
 * INPUT:   mission  -- The mission number to convert. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the ASCII string that represents the
 *mission type.       *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *                                                                                             *
 * INPUT:      MissionType mission - the mission we want to override * TARGET
 *tarcom  - the new target we want to override                      * TARGET
 *navcom  - the new navigation point to override                    *
 *                                                                                             *
 * OUTPUT:      none *
 *                                                                                             *
 * WARNINGS:   If a mission is already overridden, the current mission is * just
 *re-assigned.                                                             *
 *                                                                                             *
...
/***********************************************************************************************
 * MissionClass::Is_Recruitable_Mission -- Determines if this mission is
 *recruitable for a tea *
 *                                                                                             *
 *    Some missions preclude recruitment into a team. This routine will examine
 *the mission    * specified and if not allowed for a team, it will return
 *false.                           *
 *                                                                                             *
 * INPUT:   mission  -- The mission type to examine. *
 *                                                                                             *
 * OUTPUT:  bool; Is an object following this mission allowed to be recruited
 *into a team?     *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
