      ...
      if (!IsRotating && PrimaryFacing != DIR_W) {
        ...
        if (!IsDriving) {
          ...
          if (IsTethered && whom != nullptr) {
            if (whom->What_Am_I() == RTTI_BUILDING &&
    ...
    if (Class->IsCrew && Class->Max_Passengers() == 0) {
      if (Percent_Chance(50)) {
        ...
        if (Class->PrimaryWeapon == nullptr) {
          ...
          if (i != nullptr) i->IsTechnician = true;
        } else {
      ...
      while (Is_Something_Attached()) {
        ...
        if (object == nullptr) break;  // How can this happen?
...
bool UnitClass::Tiberium_Check(CELL &center, int x, int y) {
  ...
  */
  ...
  if ((Session.Type != GAME_NORMAL ||
       (!IsOwnedByPlayer || Map[center].IsMapped))) {
      ...
      */
      ...
      if (House->Is_Ally(obj)) {
        if (is_moving) {
          ...
          int techface =
              Dir_Facing(((FootClass const *)obj)->PrimaryFacing) ^ 4;
          if (face == techface &&
        ...
        if (!obj->Is_Techno() || ((TechnoClass *)obj)->Cloak != CLOAKED) {
          ...
          */
          ...
          if (!crusher || !obj->Class_Of().IsCrushable) {
            ...
            */
            if (Class->PrimaryWeapon == nullptr) return (MOVE_NO);
...
void UnitClass::Shroud_Regen(void) {
  if (Class->IsGapper /*KO && !House->IsPlayerControl*/) {
    static int _xtab[] = {-1, 0,  1,  -2, -1, 0, 1,  2,  -2, -1, 0,
                          ...
                          2,  -2, -1, 0,  1,  2, -1, 0,  1};
    static int _ytab[] = {-3, -3, -3, -2, -2, -2, -2, -2, -1, -1, -1,
