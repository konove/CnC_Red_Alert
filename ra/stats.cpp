 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Overview: * Internet game statistics to collect and upload to the server *
 *                                                                                             *
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 *                                                                                             *
...
//		stats.Add_Field( FIELD_HARDWARE_GUID, hwinfo.szHwProfileGuid );
    ...
    */
    stats.Add_Field(FIELD_START_CREDITS,
                    (unsigned long)Session.Options.Credits);
    ...
    */
    stats.Add_Field(FIELD_START_UNIT_COUNT,
                    (unsigned long)Session.Options.UnitCount);
...
// player->IniName );
      ...
      */
      ...
      /*
      ** Clear out the counts and use the space to count up the current number
      *of units/buildings
      */
