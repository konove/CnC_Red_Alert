 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * CheckBoxClass::Action -- Handles a button action on a checkbox
 *object.                    * CheckBoxClass::Draw_Me -- Draws the checkbox
 *imagery.                                     *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *                                                                                             *
 *    This routine will detect if the mouse has been clicked on the checkbox
 *object. If so,    * the check box state will be toggled. *
 *                                                                                             *
