...
*consists of a fill *	and a background region. The fill percentage of the
*bargraph is controlled by an *	update value. The bargraph can be optionally
*outlined.
*/
class ProgressBarClass {
 public:
  ProgressBarClass(int x, int y, int width, int height, int forecolor,
