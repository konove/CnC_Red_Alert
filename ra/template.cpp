 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * TemplateClass::Init -- Resets the template object system. *
 ...
 *   TemplateClass::Unlimbo -- Places a template object into the game/map
 *system.              * TemplateClass::delete -- Returns a template object to
 *the pool.                           * TemplateClass::new -- Allocates a
 *template object from pool                               *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
