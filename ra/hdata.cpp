 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * HouseTypeClass::As_Reference -- Fetches a reference to the house
 *specified.               * HouseTypeClass::From_Name -- Fetch house pointer
 *from its name.                           * HouseTypeClass::HouseTypeClass --
 *Constructor for house type objects.                     *
 *   HouseTypeClass::Init_Heap -- Allocate all heap objects for the house types.
 ** HouseTypeClass::One_Time -- One-time initialization *
 *   HouseTypeClass::Read_INI -- Fetch the house control values from ini
 *database.             * HouseTypeClass::Remap_Table -- Fetches the remap table
 *for this house.                    * HouseTypeClass::operator delete --
 *Returns a house type object back to the heap.          *
 *   HouseTypeClass::operator new -- Allocates a house type class object from
 *special heap.    *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *                                                                                             *
 *    This is the constructor for house type objects. This object holds the
 *constant data      * for the house type. *
 *                                                                                             *
 * INPUT:   see below... *
 *                                                                                             *
 * OUTPUT:  none *
 ...
 *special heap.      *
 *                                                                                             *
 *    This will allocate a house type object from the special heap that is used
 *to maintain    * objects of this type. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
...
/***********************************************************************************************
 * HouseTypeClass::operator delete -- Returns a house type object back to the
 *heap.            *
 *                                                                                             *
 *    This will return the house type object specified back into the special
 *heap that         * is used to maintain house type objects. *
 *                                                                                             *
 ...
 * HouseTypeClass::Init_Heap -- Allocate all heap objects for the house types. *
 *                                                                                             *
 *    This will preallocate all the house types. They must be allocated in a
 *particular order. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   This routine should be called only once at the beginning of the
 *game.           *
 *                                                                                             *
 * HISTORY: * 09/04/1996 JLB : Created. *
 *=============================================================================================*/
 ...
 *                                                                                             *
 *    This routine will convert the ASCII house name specified into a * real
 *house number. Typically, this is used when processing a * scenario INI file. *
 *                                                                                             *
 * INPUT:   name  -- ASCII name of house to process. *
 *                                                                                             *
 * OUTPUT:  Returns with actual house number represented by the ASCII * name
 *specified. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 * OUTPUT:  Returns with a reference to the HouseTypeClass object that matches
 *the house       * number specified. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    Use this routine to fetch the remap table assigned to this house. The
 *remap table is     * what gives the house's units/buildings their distinctive
 *color.                          *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 ...
 **
 *                                                                                             *
 *    This routine will fetch the rules controllable values for the house type
 *from the        * INI database specified. *
 *                                                                                             *
 * INPUT:   ini   -- Reference to the INI database to fetch the house control
 *values from.     *
 *                                                                                             *
