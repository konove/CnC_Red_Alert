...
/* $Header:   F:\projects\c&c0\vcs\code\inicode.cpv   4.38   03 Jul 1996
 * 05:14:04   JOE_BOSTIC  $ */
/***************************************************************************
...
void Get_Scenario_Digest(char* digest, char* buffer) {
  ...
  stage[0] = '\0';
  while (*tbuffer != '\0') {
    WWGetPrivateProfileString("DIGEST", tbuffer, NULL, buf, sizeof(buf) - 1,
                              buffer);
    strcat(stage, buf);
...
bool Read_Scenario_INI_Write_INB(char* root, bool fresh) {
  ...
  */
  WWGetPrivateProfileString("Basic", "Name", "", scenarioname,
                            sizeof(scenarioname), buffer);
  WWGetPrivateProfileString("Basic", "Intro", "x", Scen.IntroMovie,
                            sizeof(Scen.IntroMovie), buffer);
  WWGetPrivateProfileString("Basic", "Brief", "x", Scen.BriefMovie,
                            sizeof(Scen.BriefMovie), buffer);
  WWGetPrivateProfileString("Basic", "Win", "x", Scen.WinMovie,
                            sizeof(Scen.WinMovie), buffer);
  WWGetPrivateProfileString("Basic", "Lose", "x", Scen.LoseMovie,
                            sizeof(Scen.LoseMovie), buffer);
  WWGetPrivateProfileString("Basic", "Action", "x", Scen.ActionMovie,
                            sizeof(Scen.ActionMovie), buffer);
  Scen.IsToCarryOver =
      WWGetPrivateProfileInt("Basic", "ToCarryOver", 0, buffer);
  ...
  */
  ...
  // TCTC To Fix?
  //	Scen.CarryOverPercent = WWGetPrivateProfileInt( "Basic",
  //"CarryOverMoney", 100, buffer);
  Scen.CarryOverCap =
      WWGetPrivateProfileInt("Basic", "CarryOverCap", -1, buffer);
