 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * ListClass::Add -- This object adds itself to the given list *
 ...
 *   ListClass::Draw_Me -- Draws the listbox. * ListClass::Get_Item -- Fetches
 *an arbitrary item string.                                  *
 ...
 *   ListClass::Set_Selected_Index -- Set the top of the listbox to index
 *specified.           * ListClass::Set_Tabs -- Sets the tab stop list to be
 *used for text printing.               * ListClass::Set_View_Index -- Sets the
 *top line for the current list view.                 * ListClass::Step -- Moves
 *the list view one line in direction specified.                   *
 *   ListClass::Step_Selected_Index -- Change the listbox top line in direction
 *specified.     * ListClass::~ListClass -- Destructor for list class objects. *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *                                                                                             *
 *    This is the destructor for list objects. It handles removing anything it
 *might have      * allocated. This is typically the scroll bar. *
 *                                                                                             *
 ...
 * ListClass::Add_Item -- Adds an item to the list box. *
 *                                                                                             *
 *    This will add the specified string to the list box. The string is added to
 *the end       * of the list. *
 *                                                                                             *
 ...
 * ListClass::Add_Item -- Adds a text item (as number) to the list box. *
 *                                                                                             *
 *    This will add the text as specified by the text number provided, to the
 *list box.        * The string is added to the end of the list. *
 *                                                                                             *
 * INPUT:      text  -- The text number for the string to add to the list box. *
 * OUTPUT:     none * WARNINGS:   Once a string is added to the list box in this
 *fashion, there is no method of   * retrieving the text number as it relates to
 *any particular index in the list.   * HISTORY: * 01/15/1995 JLB : Created. *
 *=============================================================================================*/
 ...
 *pointer that    * was used to add the string to the list. *
 *                                                                                             *
 ...
 *                                                                                             *
 * INPUT:   forced   -- Should the listbox be redrawn even if it already thinks
 *it doesn't     * need to be? This is true when something outside of the gadget
 *system   * has trashed the screen. *
 *                                                                                             *
 ...
 * ListClass::Bump -- Bumps the list box up/down one "page". *
 *                                                                                             *
 *    Use this routine to adjust the "page" that is being viewed in the list
 *box. The view     * will move up or down (as specified) one page (screen full)
 *of text strings.              *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine will move the current view "page" one line in the direction
 *specified.      *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine will fetch an item string from the list box. The item fetched
 *can be any    * one of the ones in the list. *
 *                                                                                             *
 * INPUT:   index -- The index to examine and return the text pointer from. *
 *                                                                                             *
 * OUTPUT:  Returns with the text pointer to the string at the index position
 *specified.       *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  Returns with the index of the currently selected line. This ranges
 *from zero to    * the number of items in the list minus one. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 01/16/1995 JLB : Created. *
 ...
 * ListClass::Peer_To_Peer -- A peer gadget was touched -- make adjustments. *
 *                                                                                             *
 *    This routine is called when one of the peer gadgets (the scroll arrows or
 *the slider)    * was touched in some fashion. This routine will sort out whom
 *and why and then make       * any necessary adjustments to the list box. *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine is used to set the line that will be at the top of the list
 *view. This is   * how the view can be scrolled up and down. This does not
 *affect the currently selected    * item. *
 *                                                                                             *
 ...
 * ListClass::Add_Scroll_Bar -- Adds a scroll bar to the list box. *
 *                                                                                             *
 *    This routine will add a scroll bar (with matching arrows) to the list box.
 *They are      * added to the right edge and cause the interior of the list box
 *to become narrower.       *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 ...
 * ListClass::Remove_Scroll_Bar -- Removes the scroll bar if present *
 *                                                                                             *
 *    Use this routine to remove any attached scroll bar to this list box. If
 *the scroll bar   * is not present, then no action occurs. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This sets the tab stop list to be used for text printing. It specifies a
 *series of       * pixel offsets for each tab stop. The offsets are from the
 *starting pixel position that   * the text begins at. *
 *                                                                                             *
 * INPUT:   tabs  -- Pointer to a list of tab pixel offsets. *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   Only a pointer to the tabs is recorded by the ListClass object.
 *Make sure that  * the list remains intact for the duration of the existence of
 *this object.       *
 *                                                                                             *
 * HISTORY: * 01/16/1995 JLB : Created. *
 *=============================================================================================*/
 ...
 * ListClass::Draw_Entry -- Draws a list box text line as indicated. *
 *                                                                                             *
 *    This routine is called by the Draw_Me function when it desired to redraw a
 *particular    * text line in the list box. *
 *                                                                                             *
 * INPUT:   index    -- The index of the list entry to draw. This index is based
 *on the        * total list and NOT the current visible view page. *
 *                                                                                             *
 *          x,y      -- Pixel coordinates for the upper left corner of the text
 *entry.         *
 *                                                                                             *
 *          width    -- The maximum width that the text may draw over. It is
 *expected that     * this drawing routine entirely fills this length. *
 *                                                                                             *
...
void ListClass::Draw_Entry(int index, int x, int y, int width, int selected) {
  ...
  Conquer_Clip_Text_Print(List[index], x, y, scheme, TBLACK, flags, width,
                          Tabs);
}
 ...
 *                                                                                             *
 * Adds the list box to the chain, immediately after the given object.  The
 *order will be:     *
 * - Listbox *
 * - Up arrow (if active) *
 ...
 *                                                                                             *
 * OUTPUT:  Returns with a reference to the object at the head of the list. This
 *should be     * the same object that is passed in. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 01/19/1995 JLB : Created. *
 ...
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   The previous and next pointers for the added object MUST have
 *been properly     * initialized for this routine to work correctly. *
 *                                                                                             *
 * HISTORY: * 01/15/1995 JLB : Created. *
 *=============================================================================================*/
 ...
 * ListClass::Remove -- Removes the specified object from the list. *
 *                                                                                             *
 *    This routine will remove the specified object from the list of objects.
 *Because of the   * previous and next pointers, it is possible to remove an
 *object from the list without     * knowing the head of the list. To do this,
 *just call Remove() with the parameter of       * "this". *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 ...
 *specified.             *
 *                                                                                             *
 *    This routine will set the top line of the listbox to the index value
 *specified.          *
 *                                                                                             *
 ...
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   The requested index may be adjusted to fit within legal
 *parameters.             *
 *                                                                                             *
 * HISTORY: * 06/25/1995 JLB : Created. * 01/23/1996 JLB : Forces selected index
 ...
 *specified.       *
 *                                                                                             *
 *    This routine will scroll the top line of the listbox in the direction
 *specified.         *
 *                                                                                             *
 * INPUT:   step  -- The direction (and amount) to adjust the listbox. If
 *negative value, then * the top line is scrolled upward. *
 *                                                                                             *
