...
#define TEXT_ERROR_TIMER                                                      \
  "Error - Timer system failed to initialise due to system instability. You " \
...
#define TEXT_CRITICALLY_LOW                                                   \
  "Warning - you are critically low on free disk space for saving games. Do " \
  "you want to play Red Alert anyway?"
...
#define TEXT_USE_START_MENU                                               \
  ...
  "version via the Windows 95 Start Menu.\n\rPress any key.\n\r"
...
#ifdef GERMAN
#define TEXT_ERROR_TIMER                                                      \
  "Fehler - das Timer-System konnte aufgrund einer InstabilitÑt des Systems " \
...
#define TEXT_DDRAW_ERROR \
  "Fehler - Kann primÑren Videopuffer nicht finden - Abbruch."
...
#ifdef FRENCH
#define TEXT_ERROR_TIMER                                             \
  "Error - L'horloge systËme n'a pas pu s'initialiser en raison de " \
  "l'instabilitÇ du sytËme. Vous devez redÇmarrer Windows."
#define TEXT_SHORT_TITLE "Alerte Rouge"
#define TEXT_MEMORY_ERROR "Erreur - Plus de mÇmoire."
#define TEXT_ABORT "Interrompre"
#define TEXT_DDRAW_ERROR \
  " Erreur - Impossible d'allouer le tampon vidÇo principal - Interruption."
