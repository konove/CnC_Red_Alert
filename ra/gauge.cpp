 ...
 *allows the gauge to use and    * return values that are convenient for the
 ...
 * GaugeClass::Pixel_To_Value -- Convert a pixel offset into a gauge value. *
 *                                                                                             *
 *    Use this routine to convert the specified pixel offset into a gauge value.
 *This is used   * in translating mouse clicks into a corresponding setting for
 *the gauge.                  *
 *                                                                                             *
 ...
 *scanning is        * desired (for this pass). *
 *                                                                                             *
