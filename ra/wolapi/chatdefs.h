...
#define CHAT_E_CHANNELDOESNOTEXIST \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 112)
// Tried to join a channel with the wrong password
#define CHAT_E_BADCHANNELPASSWORD \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 113)
...
#define CHAT_S_CON_DISCONNECTING \
  MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_ITF, 302)
// A network connection is closed
#define CHAT_S_CON_DISCONNECTED \
  MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_ITF, 303)
