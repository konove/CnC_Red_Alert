 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * As_Aircraft -- Converts the target value into an aircraft
 *pointer.                        * As_Animation -- Converts target value into
 *animation pointer.                             * As_Building -- Converts a
 *target value into a building object pointer.                    * As_Bullet --
 *Converts the target into a bullet pointer.                                   *
 *   As_Cell -- Converts a target value into a cell number. * As_Coord --
 *Converts a target value into a coordinate value. * As_Infantry -- If the
 *target is infantry, return a pointer to it.                         *
 *   As_Movement_Coord -- Fetches coordinate if trying to move to this target. *
 *   As_Object -- Converts a target value into an object pointer. * As_Target --
 *Converts a cell into a target value.                                         *
 *   As_Target -- Converts a coordinate into a target value. * As_Team --
 *Converts a target number into a team pointer. * As_TeamType -- Converts a
 *target into a team type pointer.                                * As_Techno --
 *Converts a target value into a TechnoClass pointer.                          *
 *   As_TechnoType -- Convert the target number into a techno type class
 *pointer.              * As_Trigger -- Converts specified target into a trigger
 *pointer.                           * As_TriggerType -- Convert the specified
 *target into a trigger type.                       * As_Unit -- Converts a
 *target value into a unit pointer.                                   *
 ...
 *                                                                                             *
 *    This routine will convert the specified target number into a trigger
 *pointer.            *
 *                                                                                             *
 * INPUT:   target   -- The target number to convert. *
 *                                                                                             *
 * OUTPUT:  Returns with the trigger pointer that the specified target number
 *represents. If   * it doesn't represent a legal trigger object, then NULL is
 *returned.                *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 * INPUT:   target   -- The target number to convert. *
 *                                                                                             *
 * OUTPUT:  Returns with the team object that the specified target number
 *represents. If it    * doesn't represent a legal team then NULL is returned. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 07/08/1995 JLB : Created. *
 ...
 *                                                                                             *
 *    This routine will convert the specified target number into a team type
 *pointer.          *
 *                                                                                             *
 * INPUT:   target   -- The target number to convert. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the team type represented by the target
 *number. If the   * target number doesn't represent a legal team type, then
 *NULL is returned.          *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine will convert the specified target number into an animation
 *pointer.         *
 *                                                                                             *
 * INPUT:   target   -- The target number to convert into an animation pointer.
 **
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the legal animation that this target
 *represents. If it   * doesn't represent a legal animation, then NULL is
 *returned.                        *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine will convert the specified target number into a bullet
 *pointer.             *
 *                                                                                             *
 * INPUT:   target   -- The target number to convert. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the bullet it specifies. If the target
 *doesn't refer to  * a legal bullet, then NULL is returned. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 07/08/1995 JLB : Created. *
 ...
 *                                                                                             *
 *    This routine will convert the specified target value into an aircraft
 *object pointer.    *
 *                                                                                             *
 * INPUT:   target   -- The target value to convert. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the aircraft that this target value
 *represents. If the   * specified target value doesn't represent an aircraft,
 ...
 *                                                                                             *
 *    This routine will take the target value specified and convert it into a
 *TechnoClass      * pointer if the target represents an object that has a
 *TechnoClass.                       *
 *                                                                                             *
 * INPUT:   target   -- The target value to convert into a TechnoClass pointer.
 **
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the associated object's TechnoClass. If
 *the target       * cannot be converted into a TechnoClass pointer, then NULL
 *is returned.             *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine is used to convert the target value specified into an object
 *pointer. If    * the target doesn't represent an object or the target value is
 *illegal, then NULL is      * returned. *
 *                                                                                             *
 * INPUT:   target   -- The target value to convert from. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the object it represent, or NULL if not an
 *object.       *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine is used to convert the target value specified into a pointer
 *to a unit      * object. *
 *                                                                                             *
 * INPUT:   target   -- The target value to convert into a unit pointer. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the unit the target value represents or
 *NULL if not      * a unit. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 * As_Vessel -- Converts a target number into a vessel pointer. *
 *                                                                                             *
 *    Use this routine to conver the specified target number into a pointer to a
 *vessel object * that it represents. *
 *                                                                                             *
 * INPUT:   target   -- The target number to convert to a vessel pointer. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the vessel object that this target value
 *represents. If  * the target number does not represent a vessel, then null is
 *returned.              *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine will translate the specified target value into an infantry
 *pointer if the   * target actually represents an infantry object. *
 *                                                                                             *
 * INPUT:   target   -- The target to convert to a pointer. *
 *                                                                                             *
 * OUTPUT:  Returns a pointer to the infantry object that this target value
 *represents. If     * the target doesn't represent an infantry object, then
 *return NULL.                 *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine is used to convert the target value specified into a building
 *pointer.      *
 *                                                                                             *
 * INPUT:   target   -- The target value to convert from. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the building object that the target value
 *represents.    * If it doesn't represent a building, then return NULL. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 05/27/1994 JLB : Created. *
 ...
 * Target_Legal -- Determines if the specified target is legal. *
 *                                                                                             *
 *    This routine is used to check for the legality of the target value
 *specified. It is      * necessary to call this routine if there is doubt about
 *the the legality of the target.   * It is possible for the unit that a target
 *value represents to be eliminated and thus     * rendering the target value
 *invalid.                                                      *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine is used to convert the target value specified, into a cell
 *value. This is   * necessary for find path and other procedures that need a
 *cell value.                     *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine is used to convert the target value specified into a
 *coordinate value. It   * is necessary for those procedures that require a
 *coordinate value.                       *
 *                                                                                             *
 * INPUT:   target   -- The target value to convert. *
 *                                                                                             *
 ...
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 05/27/1994 JLB : Created. * 11/16/1994 JLB : Simplified. *
 *=============================================================================================*/
COORDINATE As_Coord(TARGET target) {
  if (Target_Legal(target)) {
    /*
    **	Cell target values are handled as a special case. The value of the
    ...
    */
    ...
    /*
    **	Normal targets correspond to game objects. Fetch the object pointer and
 ...
 * As_Movement_Coord -- Fetches coordinate if trying to move to this target. *
 *                                                                                             *
 *    This routine will convert the specified target into a coordinate location.
 *This location * is used when moving to the target specified. For cells, this
 *is the center of the cell.  * For special buildings that allow docking, it is
 *the center location of the docking       * bay. *
 *                                                                                             *
 ...
 * TargetClass::As_Object -- Converts a target into an object pointer. *
 *                                                                                             *
 *    If the target represents an object of some type, then this routine will
 *return a         * pointer to the object. Otherwise it will return NULL. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the object that this target represents or
 *NULL if it     * doesn't represent a target. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 * TargetClass::As_Techno -- Converts a target into a techno object pointer. *
 *                                                                                             *
 *    This routine is used to convert the target object into a pointer to a
 *techno class       * object. If the target doesn't specify a techno class
 *object, then NULL is returned.      *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the techno class object that this target
 *represents or   * else it returns NULL. *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 03/05/1996 JLB : Created. *
 ...
 *                                                                                             *
 *    This routine is used to convert the specified coordinate into a target
 *value.            *
 *                                                                                             *
 ...
 **
 *                                                                                             *
 *    This routine will conver the specified target number into a pointer to the
 *techno        * type class that it represents. *
 *                                                                                             *
 * INPUT:   target   -- The target number to convert. *
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the TechnoTypeClass object that the target
 *number        * represents. If it doesn't represent that kind of object, then
 *NULL is returned.    *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 ...
 *                                                                                             *
 *    This routine will conver the target number into a pointer to the trigger
 *type it         * represents. *
 *                                                                                             *
 * INPUT:   target   -- The target value to convert into a trigger type pointer.
 **
 *                                                                                             *
 * OUTPUT:  Returns with a pointer to the trigger type object that the specified
 *target value  * represents. If it doesn't represent a trigger type, then NULL
 *is returned.         *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
