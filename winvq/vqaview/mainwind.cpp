...
long WINAPI Main_Window_Message_Handler(WindowHandle window_handle,
...
void MainWindowClass::Create_Main_Window(InstanceHandle instance_handle) {
  ...
  //
  main_window_handle =
      CreateWindowEx(WS_EX_TOPMOST,      // extended window info
...
void MainWindowClass::Display_Window(void) {
  ...
  //
  Set_Video_Mode(main_window_handle, VIDEO_MODE_WIDTH, VIDEO_MODE_HEIGHT,
